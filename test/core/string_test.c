...
{
    uint8_t src[100] = "my short string";
    uint8_t dst[100];
...
{
    uint8_t src[100] = "my long string that's too long for the destination";
    uint8_t dst[100];
...
{
    uint8_t dst[100] = "my little pony";
    int length;
...
{
    assert_eq(-1, string_to_int((uint8_t *) "-1"));
    assert_eq(-123, string_to_int((uint8_t *) "-123"));
}
...
{
    assert_eq(0, string_to_int((uint8_t *) "1234567890"));
}

void test_string_to_int_non_numeric_postfix_ignored()
{
    assert_eq(12345, string_to_int((uint8_t *) "12345bladibla"));
    assert_eq(12345, string_to_int((uint8_t *) "12345.56"));
}
