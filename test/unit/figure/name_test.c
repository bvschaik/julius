...
void test_figure_name_get_increases_count()
{
    ...
    int n1 = figure_name_get(FIGURE_ACTOR, 0);
    int n2 = figure_name_get(FIGURE_ACTOR, 0);
...
void test_figure_name_get_wraps()
{
    ...
    int n0 = figure_name_get(FIGURE_ACTOR, 0);
    for (int i = 0; i < 31; i++) {
        figure_name_get(FIGURE_ACTOR, 0);
    }
    int n32 = figure_name_get(FIGURE_ACTOR, 0);
...
{
    int result = figure_name_get(type, 0);
