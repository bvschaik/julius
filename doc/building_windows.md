...
1. Obtain [MinGW-w64](https://sourceforge.net/projects/mingw-w64/) and proceed to install it. The default options are good enough.
...
2. Add the MinGW-w64 binaries to the `path`:
    ...
    * On the new window that appears, select `New` and type `C:\Program Files (x86)\mingw-w64\i686-8.1.0-posix-dwarf-rt_v6-rev0\mingw32\bin`.
