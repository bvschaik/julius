...
enum {
    ...
    FIGURE_ACTION_207_WORK_CAMP_SLAVE_FOLLOWING = 209,
    FIGURE_ACTION_208_WORK_CAMP_SLAVE_GOING_TO_MONUMENT = 210,
    FIGURE_ACTION_207_WORK_CAMP_SLAVE_DELIVERING_RESOURCES = 211,
