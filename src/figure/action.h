...
enum {
    ...
    FIGURE_ACTION_206_WORK_CAMP_ENGINEER_CREATED = 206,
    FIGURE_ACTION_207_WORK_CAMP_ENGINEER_GOING_TO_MONUMENT = 207,
    FIGURE_ACTION_208_WORK_CAMP_ENGINEER_WORKING_ON_MONUMENT = 208,
