...
void Terrain_addBuildingToGrids(int buildingId, int x, int y, int size, int graphicId, int terrain)
{
    ...
    for (int dy = 0; dy < size; dy++)
    {
        for (int dx = 0; dx < size; dx++)
        {
            ...
            {
            case 1:
                Data_Grid_bitfields[gridOffset] |= Bitfield_Size1;
                break;
            case 2:
                Data_Grid_bitfields[gridOffset] |= Bitfield_Size2;
                break;
            case 3:
                Data_Grid_bitfields[gridOffset] |= Bitfield_Size3;
                break;
            case 4:
                Data_Grid_bitfields[gridOffset] |= Bitfield_Size4;
                break;
            case 5:
                Data_Grid_bitfields[gridOffset] |= Bitfield_Size5;
                break;
            }
