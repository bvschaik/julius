...
enum
{
    ...
    GROUP_EMPIRE_CITYTrade = 175,
    GROUP_EMPIRE_CITYDistantRoman = 176,
    ...
    GRAPHIC_LOADINGSCREEN = 251,
    GROUP_INTERMEZZO_BACKGROUND = 252,
    GROUP_PANEL_WINDOWSDesert = 253,
    GROUP_SELECT_MISSIONButton = 254,
};
