...
static window_type windows[] = {
    ...
    { Window_DifficultyOptions, noop, UI_DifficultyOptions_drawForeground, UI_DifficultyOptions_handleMouse, noop, noop },
    ...
    // 20
    { Window_CCKSelection, noop, noop, noop, noop },
    ...
    { Window_Logo, UI_Logo_drawBackground, noop, UI_Logo_handleMouse, noop, UI_Logo_init },
};
