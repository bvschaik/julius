...
static window_type windows[] = {
    // 0
    { Window_MainMenu, UI_MainMenu_drawBackground, UI_MainMenu_drawForeground, UI_MainMenu_handleMouse, noop },
    { Window_City, UI_City_drawBackground, UI_City_drawForeground, UI_City_handleMouse, UI_City_getTooltip, noop },
    { Window_PopupDialog, UI_PopupDialog_drawBackground, UI_PopupDialog_drawForeground, UI_PopupDialog_handleMouse, noop },
    { Window_TopMenu, UI_City_drawBackground, UI_TopMenu_drawForeground, UI_TopMenu_handleMouse, noop },
    { Window_DifficultyOptions, noop, UI_DifficultyOptions_drawForeground, UI_DifficultyOptions_handleMouse, noop },
    ...
    { Window_SetSalaryDialog, UI_SetSalaryDialog_drawBackground, UI_SetSalaryDialog_drawForeground, UI_SetSalaryDialog_handleMouse, noop },
    ...
    { Window_SendGiftToCaesarDialog, UI_SendGiftToCaesarDialog_drawBackground, UI_SendGiftToCaesarDialog_drawForeground, UI_SendGiftToCaesarDialog_handleMouse, UI_SendGiftToCaesarDialog_init },
    ...
    { Window_ResourceSettingsDialog, UI_ResourceSettingsDialog_drawBackground, UI_ResourceSettingsDialog_drawForeground, UI_ResourceSettingsDialog_handleMouse, noop },
    { Window_MessageDialog, UI_MessageDialog_drawBackground, UI_MessageDialog_drawForeground, UI_MessageDialog_handleMouse, UI_MessageDialog_init },
    ...
    // 20
    { Window_CCKSelection, UI_CCKSelection_drawBackground, UI_CCKSelection_drawForeground, UI_CCKSelection_handleMouse, UI_CCKSelection_init },
    { Window_FileDialog, UI_FileDialog_drawBackground, UI_FileDialog_drawForeground, UI_FileDialog_handleMouse, noop },
    { Window_OverlayMenu, UI_OverlayMenu_drawBackground, UI_OverlayMenu_drawForeground, UI_OverlayMenu_handleMouse, UI_OverlayMenu_init },
    { Window_BuildingMenu, UI_BuildingMenu_drawBackground, UI_BuildingMenu_drawForeground, UI_BuildingMenu_handleMouse, noop },
    { Window_Intermezzo, UI_Intermezzo_drawBackground, noop, UI_Intermezzo_handleMouse, noop },
    ...
    { Window_NewCareerDialog, UI_NewCareerDialog_drawBackground, UI_NewCareerDialog_drawForeground, UI_NewCareerDialog_handleMouse, UI_NewCareerDialog_init },
    ...
    { Window_MissionSelection, UI_MissionStart_Selection_drawBackground, UI_MissionStart_Selection_drawForeground, UI_MissionStart_Selection_handleMouse, noop },
    // 30
    { Window_MissionBriefingInitial, UI_MissionStart_Briefing_drawBackground, UI_MissionStart_BriefingInitial_drawForeground, UI_MissionStart_BriefingInitial_handleMouse, UI_MissionStart_Briefing_init },
    { Window_MissionBriefingReview, UI_MissionStart_Briefing_drawBackground, UI_MissionStart_BriefingReview_drawForeground, UI_MissionStart_BriefingReview_handleMouse, UI_MissionStart_Briefing_init },
    { Window_VictoryDialog, UI_VictoryDialog_drawBackground, UI_VictoryDialog_drawForeground, UI_VictoryDialog_handleMouse, noop },
    { Window_MissionEnd, UI_MissionEnd_drawBackground, UI_MissionEnd_drawForeground, UI_MissionEnd_handleMouse, noop },
    { Window_VictoryIntermezzo, noop, noop, noop, UI_VictoryIntermezzo_init },
    { Window_VideoIntermezzo, UI_VideoIntermezzo_drawBackground, UI_VideoIntermezzo_drawForeground, UI_VideoIntermezzo_handleMouse, UI_VideoIntermezzo_init },
