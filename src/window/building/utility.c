...
void window_building_draw_roadblock(building_info_context *c)
{
    ...
    window_building_draw_description_at(c, CUSTOM_TRANSLATION, TR_BUILDING_ROADBLOCK_DESC, 96);
}
...
void window_building_draw_garden_gate(building_info_context *c)
{
    ...
    window_building_draw_description_at(c, CUSTOM_TRANSLATION, TR_BUILDING_GARDEN_WALL_GATE_DESC, 96);
}
...
void window_building_draw_palisade_gate(building_info_context *c)
{
    ...
    window_building_draw_description_at(c, CUSTOM_TRANSLATION, TR_BUILDING_PALISADE_GATE_DESC, 96);
}
