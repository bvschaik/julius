...
static generic_button checkbox_buttons[] = {
    ...
    { 20, 288, 20, 20, toggle_switch, button_none, CONFIG_GP_FIX_EDITOR_EVENTS }
};
...
static void draw_background(void)
{
    ...
    text_draw(string_from_ascii("Fix Emperor change and survival time in custom missions"), 50, 293, FONT_NORMAL_BLACK, 0);
