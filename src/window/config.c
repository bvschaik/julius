...
static generic_button checkbox_buttons[] = {
    ...
    { 20, 288, 20, 20, toggle_switch, button_none, CONFIG_GP_FIX_IMMIGRATION_BUG },
    { 20, 312, 20, 20, toggle_switch, button_none, CONFIG_GP_FIX_100_YEAR_GHOSTS },
    { 20, 336, 20, 20, toggle_switch, button_none, CONFIG_GP_FIX_EDITOR_EVENTS }
};
...
static void draw_background(void)
{
    ...
    text_draw(string_from_ascii("Show draggable construction size"), 50, 221, FONT_NORMAL_BLACK, 0);
    text_draw(string_from_ascii("Gameplay changes"), 20, 269, FONT_NORMAL_BLACK, 0);
    text_draw(string_from_ascii("Fix immigration bug on very hard"), 50, 293, FONT_NORMAL_BLACK, 0);
    text_draw(string_from_ascii("Fix 100-year-old ghosts"), 50, 317, FONT_NORMAL_BLACK, 0);
    text_draw(string_from_ascii("Fix Emperor change and survival time in custom missions"), 50, 341, FONT_NORMAL_BLACK, 0);
