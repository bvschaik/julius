...
static generic_button buttons[] = {
    ...
    {240, 152, 360, 177, GB_IMMEDIATE, button_resource, button_none},
    {100, 192, 300, 217, GB_IMMEDIATE, button_toggle_rise, button_none},
    {350, 192, 450, 217, GB_IMMEDIATE, button_amount, button_none},
    {30, 230, 280, 255, GB_IMMEDIATE, button_delete, button_none},
    {320, 230, 420, 255, GB_IMMEDIATE, button_save, button_none}
};
