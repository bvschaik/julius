...
static void button_caesar_salary(int param1, int param2);
...
static generic_button buttons[] = {
    {262, 48, 200, 30, button_rank, button_none},
    {262, 88, 200, 30, button_caesar_salary, button_none},
    {262, 128, 200, 30, button_start_year, button_none},
    {262, 168, 200, 30, button_initial_funds,button_none},
    {262, 208, 200, 30, button_rescue_loan,button_none},
    {262, 248, 200, 30, button_wheat,button_none},
    {262, 288, 200, 30, button_flotsam, button_none, 0},
    {262, 328, 200, 30, button_milestone, button_none, 25},
    {262, 368, 200, 30, button_milestone, button_none, 50},
    {262, 408, 200, 30, button_milestone, button_none, 75}
};
...
{
    if (generic_buttons_handle_mouse(mouse_in_dialog(m), 0, 0, buttons, 10, &focus_button_id)) {
        return;
    }
