...
int Widget_Text_draw(const char *str, int x, int y, font_t font, color_t color);

void Widget_Text_drawCentered(const char *str, int x, int y, int boxWidth, font_t font, color_t color);
...
int Widget_Text_getWidth(const char *str, font_t font);
