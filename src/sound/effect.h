...
enum {
    ...
    SOUND_EFFECT_CITIZEN_DIE = 36, // 6x
    SOUND_EFFECT_FEMALE_CITIZEN_DIE = 42,
    SOUND_EFFECT_SHEEP_DIE = 43,
    SOUND_EFFECT_ZEBRA_DIE = 44,
    SOUND_EFFECT_WOLF_HOWL = 45,
    SOUND_EFFECT_FIRE_SPLASH = 46,
    SOUND_EFFECT_FORMATION_SHIELD = 47
};
