...
static GameFilePart saveGameParts[SAVEGAME_PARTS] = {
	...
	{1, &undo_grid_aqueducts, 26244},
	{1, &undo_grid_animation, 26244},
	{1, &walker_inUse, 0x1F400},
	{1, &destinationpath_index, 0x4B0},
	{1, &destinationpath_data, 0x493E0},
	{1, &formation_start_inUse, 0x1900},
	{0, &formationId_lastInUse, 4},
	{0, &formationId_lastFort, 4},
	{0, &numForts, 4},
	{1, &cityinfo_start__, 0x8D28},
	{0, &byte_658DCC, 2},
	{0, &save_player0name, 0x40},
	{0, &ciid, 4},
	{1, &building_inUse, 0x3E800},
	{0, &mapOrientation, 4},
	{0, &game_ticks, 4},
	{0, &game_weeks, 4},
	{0, &gametime_month, 4},
	{0, &gametime_year, 4},
	{0, &gametime_totalWeeks, 4},
	{0, &buildingId_highestInUseEver, 4},
	{0, &dword_98C480, 4},*/
	{0, &Data_Random.iv1, 4},
	{0, &Data_Random.iv2, 4},
	{0, &Data_Settings_Map.camera.x, 4},
	...
	{0, &populationAdvisor_graphOrder, 4},
	{0, &unk_650060, 4},
	{0, &event_emperorChange_gameYear, 4},
	{0, &event_emperorChange_month, 4},
	{0, &empire_scroll_x, 4},
	{0, &empire_scroll_y, 4},
	{0, &empire_selectedCity, 4},*/
	{1, &Data_Empire_Cities, 2706},
	{0, &Data_CityInfo_Buildings.industry.total, 64},
	{0, &Data_CityInfo_Buildings.industry.working, 64},/*
	{0, &tradeprices_buy, 0x80},
	{0, &seqWalkerName_citizen, 4},
	{0, &seqWalkerName_patrician, 4},
	{0, &seqWalkerName_female, 4},
	{0, &seqWalkerName_taxCollector, 4},
	{0, &seqWalkerName_engineer, 4},
	{0, &seqWalkerName_prefect, 4},
	{0, &seqWalkerName_javelinThrower, 4},
	{0, &seqWalkerName_cavalry, 4},
	{0, &seqWalkerName_legionary, 4},
	{0, &seqWalkerName_actor, 4},
	{0, &seqWalkerName_gladiator, 4},
	{0, &seqWalkerName_lionTamer, 4},
	{0, &seqWalkerName_charioteer, 4},
	{0, &seqWalkerName_barbarian, 4},
	{0, &seqWalkerName_greek, 4},
	{0, &seqWalkerName_egyptian, 4},
	{0, &seqWalkerName_arabian, 4},
	{0, &seqWalkerName_trader, 4},
	{0, &seqWalkerName_tradeShip, 4},
	{0, &seqWalkerName_unknown1, 4},
	{0, &seqWalkerName_unknown2, 4},
	{0, &pctTheaterCoverage, 4},
	{0, &pctAmphitheaterCoverage, 4},
	{0, &pctColosseumCoverage, 4},
	{0, &pctHospitalCoverage, 4},
	{0, &pctHippodromeCoverage, 4},
	{0, &pctReligionCoverageCeres, 4},
	{0, &pctReligionCoverageNeptune, 4},
	{0, &pctReligionCoverageMercury, 4},
	{0, &pctReligionCoverageMars, 4},
	{0, &pctReligionCoverageVenus, 4},
	{0, &pctReligionCoverageOracles, 4},
	{0, &pctSchoolCoverage, 4},
	{0, &pctLibraryCoverage, 4},
	{0, &pctAcademyCoverage, 4},
	{0, &pctHospitalCoverage, 4},
	{0, &scn_settings_startYear, 0x6B8},
	{0, &timeLimit_maxGameYear, 4},
	{0, &event_earthquake_gameYear, 4},
	{0, &event_earthquake_month, 4},
	{0, &event_earthquake_state, 4},
	{0, &dword_89AA8C, 4},
	{0, &event_earthquake_maxDuration, 4},
	{0, &event_earthquake_maxDamage, 4},
	{0, &dword_89AB08, 4},
	{0, &dword_929660, 0x20},
	{0, &event_emperorChange_state, 4},*/
	...
	{0, &dword_607FC8, 4},
	{0, &startingFavor, 4},
	{0, &personalSavings_lastMission, 4},
	{0, &setting_currentMissionId, 4},
	{1, &byte_98EF40, 0xCA0},
	{0, &setting_isCustomScenario, 4},
	{0, &dword_9D82E0, 0x2300},
	{0, &buildingId_highestInUse, 4},
	{0, &dword_993F60, 0x12C0},
	{0, &dword_990CD8, 4},
	{1, &word_98C080, 0x3E8},
	{1, &word_949F00, 0x3E8},
	{1, &gametick_tmpBuildingList, 0xFA0},*/
	{0, &Data_Tutorial_tutorial1.fire, 4},
	...
	{0, &tutorial2_potteryMadeYear, 4},
	{0, &event_gladiatorRevolt_gameYear, 4},
	{0, &event_gladiatorRevolt_month, 4},
	{0, &event_gladiatorRevold_endMonth, 4},
	{0, &event_gladiatorRevolt_state, 4},*/
	{1, &Data_Empire_Trade.maxPerYear, 12800},
	{1, &Data_Empire_Trade.tradedThisYear, 12800},/*
	{0, &dword_7FA224, 4},
	{0, &buildingId_placedSequence, 4},
	{0, &unk_634474, 4},
	{0, &dword_614158, 4},
	{0, &dword_634468, 4},
	{0, &unk_634470, 4},*/
	...
	{0, &dword_607F9C, 4},
	{0, &dword_607FA0, 4},
	{0, &lastInvasionInternalId, 2},
	{0, &dword_98C064, 4},
	{0, &dword_94A30C, 4},
	{0, &currentScenarioFilename, 0x41},
	{0, &mapBookmarks_x, 0x20},
	{0, &tutorial2_disease, 4},
	{0, &dword_8E7B24, 4},
	{0, &dword_89AA64, 4},*/
	{0, &endMarker, 4},
	{0, &endMarker, 4},
