...
static GameFilePart saveGameParts[SAVEGAME_PARTS] = {
	...
	{0, &tmp, 4}, //{0, &gametime_month, 4},
	{0, &tmp, 4}, //{0, &gametime_year, 4},
	{0, &tmp, 4}, //{0, &gametime_totalWeeks, 4},
	...
	{0, &tmp, 4}, //{0, &seqWalkerName_citizen, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_patrician, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_female, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_taxCollector, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_engineer, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_prefect, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_javelinThrower, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_cavalry, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_legionary, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_actor, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_gladiator, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_lionTamer, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_charioteer, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_barbarian, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_greek, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_egyptian, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_arabian, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_trader, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_tradeShip, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_unknown1, 4},
	{0, &tmp, 4}, //{0, &seqWalkerName_unknown2, 4},
	...
	{0, &tmp, 4}, //{0, &tutorial2_potteryMadeYear, 4},
