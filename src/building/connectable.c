...
static const building_image_context building_images_treeless_path[8] = {
    { { 1, 2, 0, 2, 1, 2, 0, 2 }, { 62, 0,  62,  0 }, -1 },
    { { 0, 2, 1, 2, 0, 2, 1, 2 }, {  0, 62,  0, 62 }, -1 },
    { { 1, 2, 0, 2, 0, 2, 0, 2 }, { 62, 0,  62,  0 }, -1 },
    { { 0, 2, 1, 2, 0, 2, 0, 2 }, {  0, 62,  0, 62 }, -1 },
    { { 0, 2, 0, 2, 1, 2, 0, 2 }, { 62, 0,  62,  0 }, -1 },
    { { 0, 2, 0, 2, 0, 2, 1, 2 }, {  0, 62,  0, 62 }, -1 },
    { { 2, 2, 2, 2, 2, 2, 2, 2 }, { 62, 0,  62,  0 },  0 },
    { { 2, 2, 2, 2, 2, 2, 2, 2 }, {  0, 62,  0, 62 }, -1 },
};
