...
typedef enum {
    ...
    BUILDING_MENU_TREES = 116,
    BUILDING_MENU_PATHS = 117,
    BUILDING_MENU_PARKS = 118,
    BUILDING_SMALL_POND = 119,        
    BUILDING_LARGE_POND = 120,
    BUILDING_PINE_TREE = 121,
    BUILDING_FIR_TREE = 122,
    BUILDING_OAK_TREE = 123,
    BUILDING_ELM_TREE = 124,
    BUILDING_FIG_TREE = 125,
    BUILDING_PLUM_TREE = 126,
    BUILDING_PALM_TREE = 127,
    BUILDING_DATE_TREE = 128,
    BUILDING_PINE_PATH = 129,
    BUILDING_FIR_PATH = 130,
    BUILDING_OAK_PATH = 131,
    BUILDING_ELM_PATH = 132,
    BUILDING_FIG_PATH = 133,
    BUILDING_PLUM_PATH = 134,
    BUILDING_PALM_PATH = 135,
    BUILDING_DATE_PATH = 136,
    BUILDING_PAVILION_BLUE = 137,
    BUILDING_PAVILION_RED = 138,
    BUILDING_PAVILION_ORANGE = 139,
    BUILDING_PAVILION_YELLOW = 140,
    BUILDING_PAVILION_GREEN = 141,
    BUILDING_SMALL_STATUE_ALT = 142,
    BUILDING_SMALL_STATUE_ALT_B = 143,
    BUILDING_OBELISK = 144,
    // helper constants
    BUILDING_TYPE_MAX = 145
} building_type;
