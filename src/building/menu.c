...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_THEATER, BUILDING_TAVERN, BUILDING_AMPHITHEATER, BUILDING_COLOSSEUM, BUILDING_HIPPODROME,
    ...
    {BUILDING_PAVILION_BLUE, BUILDING_PAVILION_RED, BUILDING_PAVILION_ORANGE, BUILDING_PAVILION_YELLOW, BUILDING_PAVILION_GREEN, BUILDING_SMALL_POND, BUILDING_LARGE_POND, 0},
    ...
    {BUILDING_SMALL_STATUE, BUILDING_SMALL_STATUE_ALT, BUILDING_SMALL_STATUE_ALT_B, BUILDING_MEDIUM_STATUE, BUILDING_OBELISK, BUILDING_LARGE_STATUE, 0},
