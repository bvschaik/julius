...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_COLONNADE, BUILDING_GARDEN_WALL, BUILDING_HEDGE_LIGHT, BUILDING_HEDGE_DARK, BUILDING_PAVILION_BLUE, BUILDING_PAVILION_RED, BUILDING_PAVILION_ORANGE, BUILDING_PAVILION_YELLOW, BUILDING_PAVILION_GREEN, BUILDING_SMALL_POND, BUILDING_LARGE_POND, 0},
