...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_MENU_SMALL_TEMPLES, BUILDING_MENU_LARGE_TEMPLES, BUILDING_MENU_GRAND_TEMPLES, BUILDING_ORACLE, 0},
    ...
    {BUILDING_FORUM, BUILDING_SENATE_UPGRADED, BUILDING_GOVERNORS_HOUSE, BUILDING_GOVERNORS_VILLA, BUILDING_GOVERNORS_PALACE,
        BUILDING_SMALL_STATUE, BUILDING_SMALL_STATUE_ALT, BUILDING_SMALL_STATUE_ALT_B, BUILDING_MEDIUM_STATUE, BUILDING_OBELISK, BUILDING_LARGE_STATUE, BUILDING_ROADBLOCK, BUILDING_TRIUMPHAL_ARCH, 0},
    {BUILDING_MENU_TREES, BUILDING_MENU_PARKS, BUILDING_MENU_PATHS, BUILDING_GARDENS, BUILDING_PLAZA, BUILDING_ENGINEERS_POST, BUILDING_LOW_BRIDGE, BUILDING_SHIP_BRIDGE,
        BUILDING_SHIPYARD, BUILDING_DOCK, BUILDING_WHARF, BUILDING_WORKCAMP, BUILDING_ENGINEER_GUILD, 0},
    ...
    {BUILDING_SMALL_POND, BUILDING_LARGE_POND, BUILDING_PAVILION_BLUE, BUILDING_PAVILION_RED, BUILDING_PAVILION_ORANGE, BUILDING_PAVILION_YELLOW, BUILDING_PAVILION_GREEN, 0},
    ...
    {BUILDING_GRAND_TEMPLE_CERES, BUILDING_GRAND_TEMPLE_NEPTUNE, BUILDING_GRAND_TEMPLE_MERCURY, BUILDING_GRAND_TEMPLE_MARS, BUILDING_GRAND_TEMPLE_VENUS, 0},
};
...
static void enable_normal(int *enabled, building_type type)
{
    ...
    enable_if_allowed(enabled, type, BUILDING_ENGINEER_GUILD);
