...
void UI_Advisor_Religion_drawBackground()
{
	...
	if (Data_Settings.godsEnabled) {
		...
		Widget_GameText_drawMultiline(59, 43,
			baseOffsetX + 60, baseOffsetY + 256, 520, Font_NormalBlack, 0
		);
	}
	
	Graphics_drawImage(GraphicId(ID_Graphic_AdvisorIcons) + 9, baseOffsetX + 10, baseOffsetY + 10);
	
	Widget_GameText_draw(59, 0, baseOffsetX + 60, baseOffsetY + 12, Font_LargeBlack, 0);
	
	// table header
	Widget_GameText_draw(59, 5, baseOffsetX + 270, baseOffsetY + 32, Font_SmallPlain, 0);
	Widget_GameText_draw(59, 1, baseOffsetX + 240, baseOffsetY + 46, Font_SmallPlain, 0);
	Widget_GameText_draw(59, 2, baseOffsetX + 300, baseOffsetY + 46, Font_SmallPlain, 0);
	Widget_GameText_draw(59, 3, baseOffsetX + 450, baseOffsetY + 46, Font_SmallPlain, 0);
	Widget_GameText_draw(59, 6, baseOffsetX + 370, baseOffsetY + 18, Font_SmallPlain, 0);
	Widget_GameText_draw(59, 9, baseOffsetX + 370, baseOffsetY + 32, Font_SmallPlain, 0);
	Widget_GameText_draw(59, 7, baseOffsetX + 370, baseOffsetY + 46, Font_SmallPlain, 0);
	...
	// Ceres
	Widget_GameText_draw(59, 11, baseOffsetX + 40, baseOffsetY + 66, Font_NormalWhite, 0);
	Widget_GameText_draw(59, 16, baseOffsetX + 120, baseOffsetY + 67, Font_SmallPlain, 0);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.smallTempleCeres.total, '@', " ",
		baseOffsetX + 230, baseOffsetY + 66, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.largeTempleCeres.total, '@', " ",
		baseOffsetX + 290, baseOffsetY + 66, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo.monthsSinceFestivalCeres, '@', " ",
		baseOffsetX + 360, baseOffsetY + 66, 50, Font_NormalWhite, 0
	);
	...
	// Neptune
	Widget_GameText_draw(59, 12, baseOffsetX + 40, baseOffsetY + 86, Font_NormalWhite, 0);
	Widget_GameText_draw(59, 17, baseOffsetX + 120, baseOffsetY + 87, Font_SmallPlain, 0);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.smallTempleNeptune.total, '@', " ",
		baseOffsetX + 230, baseOffsetY + 86, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.largeTempleNeptune.total, '@', " ",
		baseOffsetX + 290, baseOffsetY + 86, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo.monthsSinceFestivalNeptune, '@', " ",
		baseOffsetX + 360, baseOffsetY + 86, 50, Font_NormalWhite, 0
	);
	...
	// Mercury
	Widget_GameText_draw(59, 13, baseOffsetX + 40, baseOffsetY + 106, Font_NormalWhite, 0);
	Widget_GameText_draw(59, 18, baseOffsetX + 120, baseOffsetY + 107, Font_SmallPlain, 0);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.smallTempleMercury.total, '@', " ",
		baseOffsetX + 230, baseOffsetY + 106, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.largeTempleMercury.total, '@', " ",
		baseOffsetX + 290, baseOffsetY + 106, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo.monthsSinceFestivalMercury, '@', " ",
		baseOffsetX + 360, baseOffsetY + 106, 50, Font_NormalWhite, 0
	);
	...
	// Mars
	Widget_GameText_draw(59, 14, baseOffsetX + 40, baseOffsetY + 126, Font_NormalWhite, 0);
	Widget_GameText_draw(59, 19, baseOffsetX + 120, baseOffsetY + 127, Font_SmallPlain, 0);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.smallTempleMars.total, '@', " ",
		baseOffsetX + 230, baseOffsetY + 126, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.largeTempleMars.total, '@', " ",
		baseOffsetX + 290, baseOffsetY + 126, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo.monthsSinceFestivalMars, '@', " ",
		baseOffsetX + 360, baseOffsetY + 126, 50, Font_NormalWhite, 0
	);
	...
	// Venus
	Widget_GameText_draw(59, 15, baseOffsetX + 40, baseOffsetY + 146, Font_NormalWhite, 0);
	Widget_GameText_draw(59, 20, baseOffsetX + 120, baseOffsetY + 147, Font_SmallPlain, 0);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.smallTempleVenus.total, '@', " ",
		baseOffsetX + 230, baseOffsetY + 146, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo_Buildings.largeTempleVenus.total, '@', " ",
		baseOffsetX + 290, baseOffsetY + 146, 50, Font_NormalWhite, 0
	);
	Widget_Text_drawNumberCentered(
		Data_CityInfo.monthsSinceFestivalVenus, '@', " ",
		baseOffsetX + 360, baseOffsetY + 146, 50, Font_NormalWhite, 0
	);
	...
	Widget_GameText_drawMultiline(59, 21 + adviceId,
		baseOffsetX + 60, baseOffsetY + 196, 512, Font_NormalBlack, 0);
}
