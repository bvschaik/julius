...
static void drawFigureInfoTrade(BuildingInfoContext *c, int figureId)
{
    ...
    if (trader_has_traded(traderId))
    {
        ...
        for (int r = Resource_Min; r < Resource_Max; r++)
        {
            ...
            {
                width += Widget_Text_drawNumber(trader_bought_resources(traderId, (resource_type)r),
        ...
        for (int r = Resource_Min; r < Resource_Max; r++)
        {
            ...
            {
                width += Widget_Text_drawNumber(trader_sold_resources(traderId, (resource_type)r),
