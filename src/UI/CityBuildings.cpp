#include "CityBuildings_private.hpp"
...
static void drawBuildingFootprints()
{
    ...
    FOREACH_XY_VIEW
    {
        ...
        else if (Data_Grid_edge[gridOffset] & Edge_LeftmostTile)
        {
            ...
            {
                Data_Buildings[0].type = (building_type)Terrain_Garden;
    ...
    FOREACH_Y_VIEW
    {
        FOREACH_X_VIEW {
            if (Data_Grid_edge[gridOffset] & Edge_LeftmostTile)
            {
                ...
                {
                case Bitfield_Size1:
                    DRAWTOP_SIZE1_C(graphicId, xGraphic, yGraphic, colorMask);
                    break;
                case Bitfield_Size2:
                    DRAWTOP_SIZE2_C(graphicId, xGraphic, yGraphic, colorMask);
                    break;
                case Bitfield_Size3:
                    DRAWTOP_SIZE3_C(graphicId, xGraphic, yGraphic, colorMask);
                    break;
                case Bitfield_Size4:
                    DRAWTOP_SIZE4_C(graphicId, xGraphic, yGraphic, colorMask);
                    break;
                case Bitfield_Size5:
                    DRAWTOP_SIZE5_C(graphicId, xGraphic, yGraphic, colorMask);
                    break;
                }
                // specific buildings
