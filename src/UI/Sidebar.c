...
static void buttonGoToProblem(int param1, int param2)
{
    int gridOffset = game.messages.next_problem_area_grid_offset();
    if (gridOffset) {
