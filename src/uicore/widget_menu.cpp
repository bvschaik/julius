...
int getMenuBarItem(const mouse *m, MenuBarItem *items, int numItems)
{
...
void Widget::Menu::drawMenuBar(MenuBarItem *items, int numItems)
{
...
int Widget::Menu::handleMenuBar(const mouse *m, MenuBarItem *items, int numItems, int *focusMenuId)
{
...
int Widget::Menu::handleMenuItem(const mouse *m, MenuBarItem *menu, int *focusSubMenuId)
{
