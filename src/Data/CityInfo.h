...
extern struct Data_CityInfo {
	...
	unsigned char soundShootArrow;
	int buildingTradeCenterBuildingId;
	int numSoldiersInCity;
	unsigned char soundHitSoldier;
	unsigned char soundHitSpear;
	unsigned char soundHitClub;
	unsigned char soundMarchEnemy;
	unsigned char soundMarchHorse;
	unsigned char soundHitElephant;
	unsigned char soundHitAxe;
	unsigned char soundHitWolf;
