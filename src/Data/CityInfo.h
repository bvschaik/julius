...
extern struct _Data_CityInfo {
	...
	int32_t financeTaxesThisYear;
	int32_t financeTaxesLastYear;
	...
	int32_t financeExportsThisYear;
	int32_t financeExportsLastYear;
	int32_t financeImportsThisYear;
	int32_t financeImportsLastYear;
	int32_t financeInterestPaidThisYear;
	int32_t financeInterestLastYear;
	int32_t financeInterestThisYear;
	int32_t financeSundriesLastYear;
	int32_t financeSundriesThisYear;
	int32_t financeConstructionLastYear;
	int32_t financeConstructionThisYear;
	int32_t financeSalaryLastYear;
	int32_t financeSalaryThisYear;
	int32_t salaryAmount;
	int32_t salaryRank;
	int32_t financeSalaryPaidThisYear;
	int32_t financeTotalIncomeLastYear;
	int32_t financeTotalIncomeThisYear;
	int32_t financeTotalExpensesLastYear;
	int32_t financeTotalExpensesThisYear;
	int32_t financeNetInOutLastYear;
	...
	int32_t financeTributeThisYear;
	int32_t financeTributeLastYear;
