...
static void load_defaults(void)
{
    ...
    add_mapping(KEY_P, KEY_MOD_NONE, HOTKEY_TOGGLE_PAUSE);
    add_mapping(KEY_SPACE, KEY_MOD_NONE, HOTKEY_TOGGLE_OVERLAY);
    add_mapping(KEY_L, KEY_MOD_NONE, HOTKEY_CYCLE_LEGION);
    add_mapping(KEY_LEFTBRACKET, KEY_MOD_NONE, HOTKEY_DECREASE_GAME_SPEED);
    add_mapping(KEY_RIGHTBRACKET, KEY_MOD_NONE, HOTKEY_INCREASE_GAME_SPEED);
    ...
    add_mapping(KEY_MINUS, KEY_MOD_NONE, HOTKEY_SHOW_ADVISOR_FINANCIAL);
    add_mapping(KEY_EQUALS, KEY_MOD_NONE, HOTKEY_SHOW_ADVISOR_CHIEF);
    add_mapping(KEY_W, KEY_MOD_NONE, HOTKEY_SHOW_OVERLAY_WATER);
    add_mapping(KEY_F, KEY_MOD_NONE, HOTKEY_SHOW_OVERLAY_FIRE);
    add_mapping(KEY_D, KEY_MOD_NONE, HOTKEY_SHOW_OVERLAY_DAMAGE);
    add_mapping(KEY_C, KEY_MOD_NONE, HOTKEY_SHOW_OVERLAY_CRIME);
    add_mapping(KEY_T, KEY_MOD_NONE, HOTKEY_SHOW_OVERLAY_PROBLEMS);
    add_mapping(KEY_A, KEY_MOD_CTRL, HOTKEY_EDITOR_TOGGLE_BATTLE_INFO);
    add_mapping(KEY_O, KEY_MOD_CTRL, HOTKEY_LOAD_FILE);
    add_mapping(KEY_S, KEY_MOD_CTRL, HOTKEY_SAVE_FILE);
