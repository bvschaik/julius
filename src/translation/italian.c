...
static translation_string all_strings[] = {
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKERS, "Non inviare risorse a officine o granai" },
    ...
    {TR_WINDOW_BUILDING_DISTRIBUTION_CART_PUSHER_GETTING, "Il trainatore sta andando a recuperare i beni da un altro magazzino." },
