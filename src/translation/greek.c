...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_LARGE_TEMPLE_CONSTRUCTION_DESC, "Για την κατασκευή αυτού του ναού θα χρειαστούν υλικά αποθηκευμένα σε μια αποθήκη, εργάτες από ένα εργοτάξιο και αρχιτέκτονες από μια συντεχνία αρχιτεκτόνων." },
