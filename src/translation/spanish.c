...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_FIX_IMMIGRATION_BUG, "Corregir bug de inmigración en Muy Difícil"},
    {TR_CONFIG_FIX_100_YEAR_GHOSTS, "Corregir bug de fantasmas con 100 años"},
    ...
    {TR_CONFIG_JEALOUS_GODS, "Desactiva la envidia entre dioses"},
    {TR_CONFIG_GLOBAL_LABOUR, "Activar mano de obra global"},
    {TR_CONFIG_SCHOOL_WALKERS, "Extiende el rango de los caminantes de los colegios"},
    {TR_CONFIG_RETIRE_AT_60, "Cambia le edad de jubilación de 50 a 60 años"},
    {TR_CONFIG_FIXED_WORKERS, "Mano de obra fija - 38% de la población plebeya"},
    {TR_CONFIG_EXTRA_FORTS, "Permite 4 fuertes adicionales"},
    {TR_CONFIG_WOLVES_BLOCK, "Inhabilita la construcción alrededor de lobos"},
    {TR_CONFIG_DYNAMIC_GRANARIES, "Bloquea los caminos no conectados de un granero"},
    {TR_CONFIG_MORE_STOCKPILE, "Las casas reservan más bienes del mercado"},
    {TR_CONFIG_NO_BUYER_DISTRIBUTION, "Las mercaderes que compran no distribuyen bienes"},
    {TR_CONFIG_IMMEDIATELY_DELETE_BUILDINGS, "Destruye edificios inmediatamente"},
    {TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD, "Los carreteros de graneros que obtienen bienes no necesitan caminos"},
    {TR_CONFIG_GRANARIES_GET_DOUBLE, "Dobla la capacidad de carreteros de graneros que obtienen bienes"},
    ...
    {TR_CONFIG_DELIVER_ONLY_TO_ACCEPTING_GRANARIES, "Alimentos no son distribuidos a graneros que obtienen bienes"},
    {TR_CONFIG_ALL_HOUSES_MERGE, "Todas las casas se unen"},
    {TR_CONFIG_WINE_COUNTS_IF_OPEN_TRADE_ROUTE, "Rutas de comercio abiertas cuentan como provisión de distintos tipos de vino"},
    ...
    {TR_CONFIG_NOT_ACCEPTING_WAREHOUSES, "Almacenes no aceptan bienes cuando se construyen"},
    {TR_CONFIG_HOUSES_DONT_EXPAND_INTO_GARDENS, "Las casas no se expanden hacia los jardines"},
    ...
    {TR_HOTKEY_EDIT_TITLE, "Presiona nuevo atajo"},
    ...
    {TR_BUILDING_ENGINEER_GUILD, "Gremio de ingenieros" },
    {TR_BUILDING_ENGINEER_GUILD_DESC, "Los ingenieros aquí trabajan sin cesar para construir monumentos para la gloria de Roma." },
    ...
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_BONUS_DESC, "Comerciantes terrestres y marítimos tienen un 50% más de capacidad. Las caravanas de mercaderes son un 25% más rápidos." },
    {TR_BUILDING_GRAND_TEMPLE_MARS_BONUS_DESC, "Entrena soldados como una barraca. Se pueden construir 4 fuertes extra." },
    {TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "Jardines, estatuas, y templos de la ciudad brillan con increíble belleza, aumentando su atractivo. Las casas reservan más bienes e involucionan más lento." },
    {TR_BUILDING_PANTHEON_BONUS_DESC, "Provee acceso a todos los dioses. Celebra festivales anuales y reduce el mantenimiento de las iglesias un 25%." },
    ...
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_1_DESC, "Los templos generan alimentos, en una cantidad dependiente del número de casas que cubren, y lo entregan al puesto de suministro." },
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "El Gran templo produce vino en una cantidad proporcional a la población con acceso a templos de Venus. Los templos lo recolectan y distribuyen a las casas." },
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_2_DESC, "Los sacerdotes proveen entretenimiento y hermosean las casas, aumentando el atractivo del vecindario sin decoraciones adicionales." },
    ...
    {TR_BUILDING_PANTHEON_MODULE_2_DESC, "Las casas con acceso al Panteón puede evolucionar un nivel adicional." },
    ...
    {TR_BUILDING_WORK_CAMP_DESC, "Los trabajadores se reunen aquí para transportar los materiales a los sitios de construcción." },
    ...
    {TR_BUILDING_MENU_GOV_RES, "Mansión del gobernador y del más grande de los dioses y qué pasa" },
    ...
    {TR_TOOLTIP_OVERLAY_LEVY, " denarii pagado mensualmente para dar mantenimiento." }, 
