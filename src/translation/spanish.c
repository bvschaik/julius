...
static translation_string all_strings[] = {
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKERS, "Detener recursos a talleres o graneros"},
    ...
    {TR_WINDOW_BUILDING_ARENA_BOTH_SHOWS, "Esta arena acoge a gladiadores y cacerías de animales, para el deleite del público local." },
    ...
    {TR_HOTKEY_SHOW_OVERLAY_DESIRABILITY, "Capa de deseabilidad" },
    ...
    {TR_FIGURE_INFO_DEPOT_DELIVER, "Despachando" },
    ...
    {TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "Esta arena acoge gladiadores y cacerías de animales, para el deleite del público local. El desarrollo local permitió a sus ciudadanos ampliar el edificio, proporcionando más asientos para ver los espectáculos." },
    ...
    {TR_WINDOW_ORIGINAL_CAMPAIGN_DESC, "La campaña original de César 3, en todo su esplendor de hace 25 años."},
