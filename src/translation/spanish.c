...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_LARGE_TEMPLE_CONSTRUCTION_DESC, "La construcción de este templo requiere material de un almacén, trabajadores de un campo de trabajo y arquitectos de un gremio de arquitectos." },
    ...
    {TR_BUILDING_LARGE_MAUSOLEUM_CONSTRUCTION_DESC, "Para construir este mausoleo se necesitará material almacenado en un depósito, trabajadores de un campo de trabajo y arquitectos de un gremio de arquitectos." },
    ...
    {TR_EDITOR_SCENARIO_EVENT_REPEAT_MIN_MONTHS, "Mínimo de meses antes de repetir: "},
    {TR_EDITOR_SCENARIO_EVENT_REPEAT_MAX_MONTHS, "Máximo de meses antes de repetir: "},
    {TR_EDITOR_SCENARIO_EVENT_MAX_NUM_REPEATS, "Número máximo de repeticiones: "},
    {TR_EDITOR_SCENARIO_EVENT_REPEATS_FOREVER, "Infinito"},
    {TR_EDITOR_SCENARIO_EVENT_DOES_NOT_REPEAT, "No se repite."},
