...
static translation_string all_strings[] = {
	...
	{TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES, "Muestra el área cubierta de fuentes y pozos cuando se construyen casas"},
    ...
    {TR_CONFIG_SHOW_MAX_POSSIBLE_PROSPERITY, "Mostrar puntuación de prosperidad máxima obtenible"},
        {TR_CONFIG_AUTO_KILL_ANIMALS, "Los ciudadanos pueden matar automáticamente animales inofensivos"},
    ...
    {TR_CONFIG_GATES_DEFAULT_TO_PASS_ALL_WALKERS, "Portal no militar permite por defecto a los caminantes "},
    ...
    {TR_BUILDING_WINDOW_INDUSTRY_LOW_EFFICIENCY_RAW_MATERIALS, "Este edificio tiene una eficiencia baja. Esto podría deberse a la falta de un destino cercano para las mercancías finales." },
    {TR_BUILDING_WINDOW_INDUSTRY_LOW_EFFICIENCY_WORKSHOPS, "Este edificio tiene una eficiencia baja. Esto podría deberse a la falta de un suministro constante de materias primas o de un destino cercano para los productos finales." },
    {TR_BUILDING_WINDOW_INDUSTRY_WHARF_AVERAGE_CATCH, "Captura media mensual:" },
    ...
    {TR_CONFIG_DIGIT_SEPARATOR, "Separar digits"},
    ...
    {TR_BUILDING_FUMIGATION_DESC, "El edificio está siendo desinsectado. La fumigación debería durar unos días."},
    {TR_OVERLAY_HEALTH, "Global"},
    {TR_OVERLAY_SICKNESS, "Enfermedad"},
    {TR_ADVISOR_HEALTH_RATING, "Calificación:"},
    {TR_ADVISOR_HEALTH_SURVEILLANCE, "Vigilancia de las enfermedades:"},
    ...
    {TR_TOOLTIP_OVERLAY_HEALTH_7, "La salud en esta casa es buena muy buena"},
    ...
    {TR_CITY_MESSAGE_TEXT_SICKNESS, "Se ha declarado la peste en la ciudad. Un edificio está en cuarentena y se han requisado médicos o cirujanos para desinfectar."},
    ...
    {TR_CITY_WARNING_BUILD_SAND_PIT, "Construye un foso de arena"},
    ...
    {TR_HOTKEY_SHOW_OVERLAY_SCHOOL, "Capa de escuelas" },
    ...
    {TR_BUILDING_ACADEMY_UPGRADE_DESC, "Esta academia está operativa. El desarrollo local permitió a sus ciudadanos ampliar el edificio, dotándolo de más salas para oraciones e investigación."},
    ...
    {TR_BUILDING_STONE_QUARRY_DESC, "Piedra de cantera para la construcción de monumentos."},
    ...
    {TR_BUILDING_SAND_PIT_DESC, "Extrae arena para la construcción de monumentos."},
    ...
    {TR_BUILDING_CONCRETE_MAKER_DESC, "Aquí, la arena se mezcla con el hormigón para la construcción de monumentos."},
    ...
    {TR_BUILDING_CONCRETE_MAKER_IMPROVE_WATER_ACCESS, "Este taller sólo tiene acceso al pozo o a la fuente. El rendimiento podría mejorar si se dispusiera de acceso directo al embalse."},
    ...
    {TR_BUILDING_CITY_MINT_DESC_NO_PALACE, "Construye tu palacio para también recaudar fondos personales desde la casa de moneda."},
    {TR_BUILDING_CITY_MINT_DESC_PALACE, "Como eres dueño de un palacio, se añaden monedas extra a tus fondos personales."},
    ...
    {TR_CITY_MESSAGE_TITLE_TRADE_ROUTE_PRICE_CHANGE, "Tarifa de la ruta comercial" },
    {TR_CITY_MESSAGE_TEXT_TRADE_ROUTE_PRICE_CHANGE, "La tarifa para abrir una ruta comercial ha cambiado." },
    ...
    {TR_CONDITION_TYPE_TRADE_ROUTE_PRICE, "Tarifa de apertura de la ruta comercial"},
    ...
    {TR_ACTION_TYPE_TRADE_ADJUST_ROUTE_OPEN_PRICE, "Cambiar la tarifa de apertura de la ruta comercial"},
    ...
    {TR_PARAMETER_VALUE_MESSAGE_GRAND_FESTIVAL, "Festival glorioso"},
    ...
    {TR_BUILDING_INFO_CARTLOAD, "carga de carro." },
    {TR_BUILDING_INFO_CARTLOADS, "cargas de carro." },
    ...
    {TR_REPLAY_MAP_NOT_FOUND_TITLE, "No se puede re jugar el mapa"},
    ...
    {TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "Esta arena acoge gladiadores y cacerías de animales, para deleite del público. El desarrollo local permitió a sus ciudadanos ampliar el edificio, proporcionando más asientos para ver los espectáculos." },
