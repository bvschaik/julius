...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_ARCHITECT_GUILD_DESC, "Arquitectos trabajan aquí sin cesar para construir monumentos a la gloria de Roma."},
    ...
    {TR_CONFIG_GP_CH_MONUMENTS_BOOST_CULTURE_RATING, "Los templos magnos completados otorgan +8 de puntuación de cultura"},
