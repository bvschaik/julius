...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_PANTHEON_BONUS_DESC, "市民可在万神殿供奉所有神灵，年度节庆都在此举行，宗教和文化建筑维护费降低25%。" }, // Note to translators: This one changed from the previous version, please update.
    ...
    {TR_BUILDING_LARGE_TEMPLE_PHASE_1, "（建设中）" },
    {TR_BUILDING_LARGE_TEMPLE_PHASE_1_TEXT, "石匠和工程师们正在用闪闪发光的大理石打造这座神圣的建筑。" },
    {TR_BUILDING_LARGE_TEMPLE_CONSTRUCTION_DESC, "建造该神庙需要仓库提供建材、劳工营提供劳动力、建筑师协会提供师傅。" },
    ...
    {TR_CHEAT_FINISHED_MONUMENTS, "建成奇观"},
    ...
    {TR_CHEAT_UPDATED_MONUMENTS, "更新奇观"},
