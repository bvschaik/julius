...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "Gärten, Statuen und Tempel erstrahlen in neuem Glanz, haben eine beträchtlich erhöhte Reichweite und bieten mehr Attraktivität. Häuser können 50% mehr Waren lagern und entwickeln sich langsamer zurück, wenn Waren oder Dienste nicht mehr verfügbar sind." },
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "Der Prachttempel produziert und lagert bis zu 16 Einheiten Wein. Die Menge ist abhängig von der Bevölkerung mit Zugang zu Tempeln der Venus. Priester der Venus sammeln und liefern diesen Wein an die Bevölkerung. Er dient als sekundärer Wein und unterstützt die Entwicklung von Häusern" },
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_2_DESC, "Priester der Venus bieten 10 Punkte in Unterhaltung und erhöhen den Attraktivitätswert von Häusern selbst. Dies erhöht die Attraktivität der Nachbarschaft ohne weitere Verstärker, wie Gärten und Statuen zu benötigen." },
    ...
    {TR_BUILDING_MARS_TEMPLE_QUOTE, "Andere schufen für Mars ein Fahrzeug mit fliegenden Rädern,\nwie er es braucht,\num Menschen und Städte aufs Schlachtfeld zu hetzen.\n-Virgil, die Aeneis; achter Gesang" },
