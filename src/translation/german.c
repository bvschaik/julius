...
static translation_string all_strings[] = {
    ...
    {TR_INVALID_LANGUAGE_MESSAGE,
        "Das gewählte Verzeichnis enthält kein gülties Sprachpaket. "
        "Bitte überprüfe das Protokoll auf Fehler."},
    {TR_BUTTON_OK, "OK"},
    {TR_BUTTON_CANCEL, "Abbrechen"},
    {TR_BUTTON_RESET_DEFAULTS, "Standardeinstellungen wiederherstellen"},
    {TR_BUTTON_CONFIGURE_HOTKEYS, "Hotkeys konfigurieren"},
    ...
    {TR_CONFIG_SIDEBAR_INFO, "Zusätzliche Informationen im Bedienfeld"},
    {TR_CONFIG_SMOOTH_SCROLLING, "Sanftes Scrollen aktivieren"},
    {TR_CONFIG_VISUAL_FEEDBACK_ON_DELETE, "Beim Roden der Landfläche das visuelle Feedback verbessern"},
    {TR_CONFIG_ALLOW_CYCLING_TEMPLES, "Erlaube alle Tempel nacheinander zu bauen"},
    {TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE, "Reichweite beim Bauen von Reservoirs, Fontänen und Brunnen anzeigen"},
    {TR_CONFIG_SHOW_CONSTRUCTION_SIZE, "Zeige ziehbare Konstuktionsgröße"},
    {TR_CONFIG_FIX_IMMIGRATION_BUG, "Behebe Immigrationsfehler auf höchstem Schwierigkeitsgrad"},
    ...
    {TR_HOTKEY_HEADER_CITY, "Tastenkombinationen für die Stadt"},
    ...
    {TR_HOTKEY_TOGGLE_FULLSCREEN, "Vollbildanzeige umschalten"},
    {TR_HOTKEY_CENTER_WINDOW, "Fenster zentrieren"},
    {TR_HOTKEY_RESIZE_TO_640, "Fenstergröße ändern auf 640x480"},
    {TR_HOTKEY_RESIZE_TO_800, "Fenstergröße ändern auf 800x600"},
    {TR_HOTKEY_RESIZE_TO_1024, "Fenstergröße ändern auf 1024x768"},
    {TR_HOTKEY_SAVE_SCREENSHOT, "Bildschirmfoto speichern"},
    {TR_HOTKEY_SAVE_CITY_SCREENSHOT, "Bildschirmfoto der gesamten Stadt speichern"},
    ...
    {TR_HOTKEY_SHOW_ADVISOR_RATINGS, "Bewertungsberater"},
    ...
    {TR_HOTKEY_SHOW_ADVISOR_EDUCATION, "Bildungsberater"},
    ...
    {TR_HOTKEY_SHOW_ADVISOR_CHIEF, "Chefberater"},
    {TR_HOTKEY_TOGGLE_OVERLAY, "Aktuelle Spezialkarte umschalten"},
