...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_BLUE_PAVILION, "farbiger Pavillon"}, //Ehemals blauer Pavillon jetzt aber mit Farbrotation.
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_DESC, "Sponsert große Spiele in Ihrem Kolosseum oder Hippodrom aus eigenem Sparguthaben."},
    ...
    {TR_SELECT_GAMES_TEXT, "Spiele werden im Kolosseum oder Hippodrom abgehalten und kosten persönliches Sparguthaben und Ressourcen."},
    ...
    {TR_WINDOW_GAMES_OPTION_5_DESC, "Das Kolosseum wird Ort der Römischen Spiele sein. Ihre Stadt wird viele Besucher von weit her empfangen, die darauf brennen, ihre Kräfte in verschiedenen Wettbewerben zu zeigen. Die Feiern werden Ihnen im nächsten Jahr die Gunst des Kaisers und des einfachen Volkes einbringen."},
    ...
    {TR_CITY_MESSAGE_TEXT_ANIMAL_GAMES_PLANNING, "Seltsame Fracht beginnt in Ihrer Stadt aufzutauchen, als Händler von den Enden der Erde schreckliche Bestien in die Käfige unter dem Kolossum liefern. Bald wird ein grausiges Spektakel Ihr Volk begeistern."},
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_NO_COVERAGE, "Keine"},
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_FULL_COVERAGE, "Perfekt"},
};
