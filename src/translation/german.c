...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_1, "Karawanen bezahlen 20% mehr für Waren, aber Verkaufen ihre Ware für 10% mehr." },
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_PREPARING, "Die Vorbereitungen für die großen Spiele sind im Gange." },
    ...
    {TR_CITY_MESSAGE_TEXT_HIPPODROME_COMPLETE, "Das Hippodrom ist fertiggestellt. Eure Bürger warten sehnsüchtig auf Ihr Kommando die Rennen zu beginnen!" },
    ...
    {TR_WINDOW_GAMES_NO_VENUE, "Veranstaltungsort ist nicht gebaut, oder hat keine Arbeiter." },
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_UNDERWAY_KG, "DIe Kalendae des Ianuarius sind im Gange. Der Geruch von Tieropfern und Weihrauch überwältigt sogar das stechende Blut und den Schweiß der Arena." },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_PREPARING_OG, "Monate bis zu den Olympischen Spielen:" },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_UNDERWAY_OG, "Die Olympischen Spiele sind im Gange. Das heilige Feuer brennt Tag und Nacht, während die Athleten um unsterblichen Ruhm wettstreiten." },
    ...
    {TR_WINDOW_BUILDING_ARENA_BOTH_SHOWS, "In dieser Arena finden Gladiatoren und Tierhetzen statt, zur Freude der Einheimischen." },
