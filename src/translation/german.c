...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_SHOW_CONSTRUCTION_SIZE, "Zeige Konstuktionsgröße beim Bauen"},
    ...
    {TR_HOTKEY_SAVE_CITY_SCREENSHOT, "Stadtweites Bildschirmfoto speichern"},
    ...
    {TR_HOTKEY_SHOW_ADVISOR_IMPERIAL, "Berater für den Impterator"},
    ...
    {TR_HOTKEY_SHOW_ADVISOR_FINANCIAL, "Beratrer für Finanzen"},
    ...
    {TR_HOTKEY_EDITOR_TOGGLE_BATTLE_INFO, "Kampfinformationen an/abschalten"},
