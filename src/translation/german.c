...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_PERCENTAGE_IN_VILLAS_PALACES, "Prozentsatz Eurer Bevölkerung in Villen und Palästen ist"},
    {TR_ADVISOR_PERCENTAGE_IN_TENTS_SHACKS, "Prozentsatz Eurer Bevölkerung in Zelten und Hütten ist"},
    {TR_ADVISOR_AVERAGE_TAX, "Durchschnittliches Steuereinkommen pro Unterkunft ist"},
    {TR_ADVISOR_AVERAGE_AGE, "Durchschnittliches Alter Eurer Bevölkerung ist"},
    {TR_ADVISOR_PERCENT_IN_WORKFORCE, "Prozentsatz Eurer Bevölkerung an Arbeitskräften ist"},
    ...
    {TR_ADVISOR_LEGION_FOOD_SATISFIED, "Eure Soldaten haben all die Nahrung, die sie benötigen."},
    ...
    {TR_CITY_MESSAGE_TEXT_MESS_HALL_MISSING, "Eure Stadt hat den Versorgungsposten verloren und Eure Soldaten hungern! Bauen Sie umgehend einen neuen Versorgungsposten!"},
