...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CITY_MINT, "lokale Münze" },
    ...
    {TR_BUILDING_CITY_MINT_FEW_EMPLOYEES, "Mit einem minimum ab Arbeiter, kommt das Prägen zum erliegen. Diese Jahr werden fast keine Münzen geprägt." },
    ...
    {TR_BUILDING_CITY_MINT_HALF_EMPLOYEES, "Die lokale Münze is unterbesetzt und das prägen von Münzen braucht länger als nötig." },
    {TR_BUILDING_CITY_MINT_MANY_EMPLOYEES, "Die lokale Münze arbeitet nicht an ihrer maximalen Kapazität. Das Prägen von Münzen wird daher weniger effektiv." },
    {TR_BUILDING_CITY_MINT_NO_EMPLOYEES, "Die lokale Münze hat keine Arbeiter, die Produktion ist gestoppt." },
    ...
    {TR_BUILDING_CITY_MINT_PHASE_1_TEXT, "Die Ingeniuere arbeiten an dem Fundament." },
    ...
    {TR_BUILDING_GOLD_MINE_MANY_EMPLOYEES, "Diese Mine arbeite unter ihrer maximalen Auslastung. Mit mehr Arbeitern wäre sie etwas effizenter." },
    {TR_BUILDING_GOLD_MINE_NO_EMPLOYEES, "Die Mine hat keien Arbeiter. Die Produktion steht still." },
    ...
    {TR_CONFIG_SHOW_MARKET_RANGE, "Zeige die Reichweite bei dem Bau von Märkten" },
    ...
    {TR_EDITOR_TOGGLE_INVASIONS, "Toggle Invasionen" },
    {TR_HOTKEY_SHOW_OVERLAY_EFFICIENCY, "Produktivtätsoverlay" },
    ...
    {TR_TOOLTIP_OVERLAY_EFFICIENCY_0, "Niemand kann sich daran erinnern wann diese Gebäude irgendetwas produziert hat." },
    {TR_TOOLTIP_OVERLAY_EFFICIENCY_1, "Dieses Gebäude produziert fast nichts." },
    {TR_TOOLTIP_OVERLAY_EFFICIENCY_2, "Hier könnte mehr produziert werden wenn die Effektivität höher wäre." },
    {TR_TOOLTIP_OVERLAY_EFFICIENCY_3, "Hier wird die Arbeit oft gestoppt, weil die Efektivität gering ist." },
