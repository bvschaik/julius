...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_TEXT, "Wählt Eure Handelspolitik in Eurer Stadt. Dies kostet 500 Dn." },
    ...
    {TR_CONFIRM_SELECT_POLICY, "Anwenden (500 Dn)"},
    ...
    {TR_CONFIRM_SELECT_EPITHET, "Anwenden (1000 Dn)"},
