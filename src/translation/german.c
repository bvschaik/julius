...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_BLUE_PAVILION, "farbiger Pavillon" },
    ...
    {TR_SELECT_EPITHET_PROMPT_TEXT, "Die Wahl eines Beinamens wird den Tempel unwiderruflich und dauerhaft auf einen Aspekt seiner Gottheit spezialisieren und die Priester mit göttlicher Macht erfüllen." },
    ...
    {TR_BUILDING_MESS_HALL_FOOD_TYPES_BONUS_2, "Eure Soldaten genießen das vielfältige und reichhaltige Nahrungsangebot. Eure Moral steigt enorm."},
    ...
    {TR_MESS_HALL_SPECIAL_ORDERS_HEADER, "Versorgungsposten Anweisungen"},
    ...
    {TR_CITY_MESSAGE_TEXT_MESS_HALL_NEEDS_FOOD, "In Eurem Versorgungsposten befindet sich sehr wenig Nahrung und die Moral der Truppen schwindet. Stellt sicher, der Versorgungsposten Zugang zu einem gut gefüllten Silo hat."},
    {TR_CITY_MESSAGE_TEXT_MESS_HALL_MISSING, "Eure Stadt hat den Versorgungsposten verloren und Eure Soldaten hungern! Baut umgehend einen neuen!"},
    {TR_MARKET_SPECIAL_ORDERS_HEADER, "Zu sammelnde Waren"},
     {TR_DOCK_SPECIAL_ORDERS_HEADER, "Dock Anweisungen"},
    {TR_TEMPLE_SPECIAL_ORDERS_HEADER, "Tempel Anweisungen"},
    {TR_TAVERN_SPECIAL_ORDERS_HEADER, "Tavernen Anweisungen"},
    ...
    {TR_CITY_MESSAGE_TEXT_PANTHEON_FESTIVAL_VENUS, "Die Gläubigen versammeln sich zur Feier von Veneralia, einem Tag, der der Venus heilig ist. Eure Bürger bitten sie um Glück in Herzensangelegenheiten."},
    ...
    {TR_CARAVANSERAI_SPECIAL_ORDERS_HEADER, "Caravanserai Anweisungen"},
    ...
    {TR_FIGURE_TYPE_CARAVANSERAI_SUPPLIER, "Caravanserai Lieferant" },
    {TR_BUILDING_CARAVANSERAI_POLICY_TITLE, "Handelspolitik" },
    {TR_BUILDING_CARAVANSERAI_NO_POLICY, "Keine Handelspolitik" },
    {TR_BUILDING_CARAVANSERAI_POLICY_TEXT, "Wählt Eure Handelspolitik in Eurer Stadt." },
    ...
    {TR_BUILDING_TAVERN_DESC_3, "Die Taverne bietet Unterhaltung solange der Wein fließt. Eine Versorgung mit Fleisch würde ihre Attraktivität erhöhen." },
    ...
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_1, "Die Bewohner verabscheuen Euren Namen."},
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_2, "Die Bewohner sind sehr sauer auf Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_3, "Die Bewohner sind sauer auf Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_4, "Die Bewohner sind sehr verärgert von Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_5, "Die Bewohner sind verärgert von Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_6, "Die Bewohner sind genervt von Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_7, "Die Bewohner sind indifferent to you." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_8, "Die Bewohner sind zufrieden mit Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_9, "Die Bewohner sind sehr zufriden mit Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_10, "Die Bewohner sind extrem zufrieden mit Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_11, "Die Bewohner lieben Euch." },
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_12, "Die Bewohner vergöttern Euch wie einen Gott." },
    ...
    {TR_BUILDING_WINDOW_HOUSE_RECENT_EVENT_NEGATIVE, "Die Bewohner sind durch ein aktuelles Ereignis verunsichert." },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_TAVERN_COVERAGE, "Tavernen" },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_HEADER, "Spiele" },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_DESC, "Sponsert große Spiele in Eurem Kolosseum oder Hippodrom aus eigenen Mitteln." },
    ...
    {TR_SELECT_GAMES_TEXT, "Spiele werden im Kolosseum oder Hippodrom abgehalten und kosten und kosten persönliche Mittel und Ressourcen." },
    {TR_BUILDING_ARENA, "Arena" },
    {TR_BUILDING_HORSE_STATUE, "Reiterstatue" },
    {TR_BUILDING_DOLPHIN_FOUNTAIN, "Delphinbrunnen" },
    {TR_BUILDING_HEDGE_DARK, "grüne Hecke" },
    ...
    {TR_CITY_MESSAGE_TEXT_HIPPODROME_COMPLETE, "Das Hippodrom ist fertiggestellt. Die Bürger warten sehnsüchtig auf Euer Kommando die Rennen zu beginnen!" },
    {TR_CITY_MESSAGE_TITLE_COLOSSEUM_WORKING, "Einweihungsspiele" },
    {TR_CITY_MESSAGE_TITLE_HIPPODROME_WORKING, "Die Rennen beginnen" },
    {TR_CITY_MESSAGE_TEXT_COLOSSEUM_WORKING, "Die Einweihungsspiele für Ihr Kolosseum haben begonnen. Auf Euren Befehl hin wird dieses Monument mit dem Blut der Tapferen geweiht!" },
    ...
    {TR_WINDOW_GAMES_OPTION_1, "Naumachie" },
    {TR_WINDOW_GAMES_OPTION_2, "Tierhetze" },
    {TR_WINDOW_GAMES_OPTION_3, "Kalendae des Ianuarius" },
    {TR_WINDOW_GAMES_OPTION_4, "Olympische Spiele" },
    {TR_WINDOW_GAMES_OPTION_5, "Römische Spiele" },
    {TR_WINDOW_GAMES_OPTION_1_DESC, "Das Kolosseum wird geflutet, um eine große Seeschlacht nachzuspielen. Erhöht die Bewegungsgeschwindigkeit der Soldaten sowie die Stärke der Soldaten in weit entfernten Schlachten für 60 Monate." },
    {TR_WINDOW_GAMES_OPTION_2_DESC, "Das Kolosseum wird Schauplatz von grausamen Tierhetzen und Hinrichtungen durch wilde Bestien, die die plebiszitären Klassen erfreuen. Kriminelle, Aufstände und Revolten werden 60 Monate lang unterdrückt. Gladiatoren werden helfen, die Stadt vor der nächsten Invasion zu verteidigen." },
    ...
    {TR_WINDOW_GAMES_OPTION_4_DESC, "Das Hippodrom wird Ort der Olympischen Spiele sein. Eure Stadt wird Scharen von Besuchern beherbergen, und wenn Eure Athleten Eure Stadt gut ehren, werdet Ihr einen dauerhaften Anstieg des Tourismus und der Gunst gewinnen." },
    {TR_WINDOW_GAMES_OPTION_5_DESC, "Das Kolosseum wird Ort der Römischen Spiele sein. Eure Stadt wird viele Besucher von weit her empfangen, die darauf brennen, ihre Kräfte in verschiedenen Wettbewerben zu zeigen. Die Feiern werden Euch im nächsten Jahr die Gunst des Kaisers und des einfachen Volkes einbringen." },
    {TR_WINDOW_GAMES_COST, "Kosten:" },
    {TR_WINDOW_GAMES_PERSONAL_FUNDS, "(persönliche Mittel)" },
    {TR_WINDOW_GAMES_NOT_ENOUGH_FUNDS, "Nicht genügend persönliche Mittel." },
    {TR_WINDOW_GAMES_NOT_ENOUGH_RESOURCES, "Nicht genügen Ressourcen gelagert." },
    ...
    {TR_CITY_MESSAGE_TEXT_ANIMAL_GAMES_PLANNING, "Seltsame Fracht beginnt in Eurer Stadt aufzutauchen, als Händler von den Enden der Erde schreckliche Bestien in die Käfige unter dem Kolossum liefern. Bald wird ein grausiges Spektakel Ihr Volk begeistern." },
    ...
    {TR_CITY_MESSAGE_TEXT_ANIMAL_GAMES_ENDING, "Die letzten der wilden Tiere liegen erschlagen im Sand des Kolosseums, ihr Blut vermischt sich mit dem der Verurteilten. Die Tierhetzen sind zu Ende." },
    ...
    {TR_CITY_MESSAGE_TEXT_OLYMPIC_GAMES_PLANNING, "Alle Augen werden auf Eure Stadt gerichtet sein, wenn die Olympischen Spiele Reisende, Wettkämpfer und römische Würdenträger aus aller Welt anlocken. Es wird nicht weniger als ein ganzes Jahr dauern, bis alle möglichen Vorbereitungen getroffen sind."},
    ...
    {TR_CITY_MESSAGE_TEXT_OLYMPIC_GAMES_ENDING, "Die heilige Flamme ist erloschen, und Reisende und Bürger strömen in müdem Jubel nach Hause. Ewiger Ruhm gebührt Euch für die erfolgreiche Ausrichtung dieser uralten und heiligen Feier der sterblichen Stärke und Ehre." },
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_PLANNING, "Mit der Ankündigung der Römischen Spiele strömen Menschen aus den entlegensten Winkeln des Imperiums in Eure Stadt, viele in der Hoffnung, die bevorstehenden Wettbewerbe zu gewinnen. Es wird nicht weniger als ein ganzes Jahr dauern, um jede mögliche Vorbereitung abgeschlossen zu sehen." },
    ...
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_ENDING, "Der letzte Tag der Römischen Spiele neigt sich dem Ende zu. Voller Aufregung und mit vollen Mägen hat jeder Bürger die Größe des römischen Lebens gekostet. Ruhm für die Sieger der Spiele und Ruhm für den Statthalter!" },
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_UNDERWAY, "Die Großen Spiele sind im Gange! Eure Stadt wimmelt von Reisenden und Feiernden." },
    ...
    {TR_BUILDING_MARS_TEMPLE_MODULE_DESC_NO_MESS, "Dieser Tempel sammelt Nahrung für Euren Versorgungsposten, sobald er gebaut ist." },
    ...
    {TR_MAP_EDITOR_OPTIONS, "Szenario Einstellungen" },
    {TR_SAVEGAME_LARGER_VERSION_TITLE, "Inkompatible Savegame-Version" },
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "Das Savegame, das Sie zu laden versuchen, ist für eine neuere Version von Augustus.\n Bitte aktualisieren Sie Augustus auf die neueste Version." },
    {TR_BUILDING_COLONNADE, "Kolonnade" },
    {TR_BUILDING_LARARIUM, "Lararium" },
    {TR_WINDOW_BUILDING_LARARIUM_DESC, "Ein kleines Heiligtum für die Götter und Vorfahren des römischen Volkes. Hier können kleine Opfer und Gebete dargebracht werden."},
    {TR_BUILDING_WATCHTOWER, "Wachturm"},
    {TR_BUILDING_WATCHTOWER_DESC, "Bogenschützen auf dem Turm halten Ausschau nach Eindringlingen, während Wächter durch die Straßen patrouillieren." },
    {TR_BUILDING_NYMPHAEUM, "Nymphaeum"},
    {TR_BUILDING_NYMPHAEUM_DESC, "Ein großer, den Nymphen geweihter Tempel verspricht dem angrenzenden Land Glück und der Stadt die Gunst des Göttlichen." },
    {TR_BUILDING_SMALL_MAUSOLEUM, "Kleines Mausoleum"},
    {TR_BUILDING_SMALL_MAUSOLEUM_DESC, "Die Ruhestätte reicher Familien ist der Neid vieler lebender." },
    {TR_BUILDING_LARGE_MAUSOLEUM, "Großes Mausoleum"},
    {TR_BUILDING_LARGE_MAUSOLEUM_DESC, "Die polierten Marmorwände dieses prächtigen Bauwerks spiegeln die großen Taten der bedeutendsten Patrizier wider, die sich das Privileg verdient haben, hier zu ruhen." },
    ...
    {TR_WARNING_VARIANT_TOGGLE, "Drücken Sie die Drehtaste, um die Varianten dieses Gebäudes umzuschalten"},
    {TR_BUILDING_SCHOOL_UPGRADE_DESC, "Die Schule ist in Betrieb, und die lokale Entwicklung ermöglichte ihre Erweiterung. So können mehr Kinder gleichzeitig lernen."},
    {TR_BUILDING_THEATRE_UPGRADE_DESC, "Die Entwicklung des Gebiets ermöglichte die Erweiterung des Theaters. Das größere Theater kann die Unterhaltungsbedürfnisse von mehr Bürgern befriedigen." },
    {TR_BUILDING_LIBRARY_UPGRADE_DESC, "Die lokale Entwicklung erlaubte es, die Bibliothek stark zu erweitern. Die neuen Schriftrollen können die Bildungsbedürfnisse für eine größere Anzahl von Römern befriedigen." },
    {TR_WINDOW_BUILDING_INFO_WARNING_NO_MONUMENT_ROAD_ACCESS, "Das Monument hat keinen Straßenzugang. Damit ein Bau möglich ist, stellt sicher, dass eine Straße an eine der mittleren Platten angeschlossen ist."},
    ...
    {TR_TOOLTIP_ADVISOR_POPULATION_HOUSING_BUTTON, "Besucht Euren Wohnraumberater." },
    {TR_BUILDING_MONUMENT_CONSTRUCTION_ARCHITECT_NEEDED, "Dieses Monument verfügt über alle Materialien, die für diese Phase benötigt werden, und wartet darauf, dass ein erfahrener Baumeister aus der Baumeistergilde die Konstruktion überwacht." },
    {TR_RETURN_ALL_TO_FORT, "Alle"},
    {TR_TOOLTIP_ADVISOR_ENTERTAINMENT_GAMES_BUTTON, "Informationen zu Spielen" },
    {TR_WINDOW_BUILDING_GOVERNMENT_LARGE_STATUE_WATER_WARNING, "Die Statue sieht fabelhaft aus, aber sie würde mit einem aktiven Brunnen noch besser aussehen, wenn Ihr sie mit Wasser versorgen würden." },
    {TR_OPTION_MENU_APPLY, "Anwenden"},
    {TR_OPTION_MENU_COST, "Die kosten dafür betragen"},
