...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_LARGE_TEMPLE_CONSTRUCTION_DESC, "Budowa tej świątyni będzie wymagała materiałów przechowywanych w magazynie, robotników z obozu pracy i architektów z gildii architektów." },
