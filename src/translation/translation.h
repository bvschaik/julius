...
typedef enum {
    ...
    TR_CITY_WARNING_BUILD_STONE_MINE,
    ...
    TR_BUILDING_VERYLOW_STAFF_DESC,
    TR_BUILDING_LOW_STAFF_DESC,
    TR_BUILDING_HALF_STAFF_DESC,
    TR_BUILDING_SOME_STAFF_DESC,
    TR_BUILDING_MOST_STAFF_DESC,
