...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_BUILDING_LARGE_TEMPLE_CONSTRUCTION_DESC, "A construção deste templo requer materiais estocados em um armazém, trabalhadores de um campo de trabalho e arquitetos de uma guilda de arquitetura." },
