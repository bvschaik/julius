...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_MAX_GRAND_TEMPLES, "Nombre maximum de grands temples par cité :"},
    ...
    {TR_BUILDING_WINDOW_HOUSE_UPSET_SQUALOR, "Les résidents sont déprimés par leur logement misérable." },
    ...
    {TR_WINDOW_GAMES_OPTION_5_DESC, "Le Colisée accueillera les Jeux Romains. Votre cité accueillera de nombreux voyageurs, désireux de prouver leur valeur. Ces célébrations vous apporteront l'estime de l'Empereur et de votre peuple pendant 12 mois." },
