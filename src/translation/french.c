...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CITY_MINT_FULL_EMPLOYEES, "L'atelier dispose de toute la main-d'œuvre nécessaire, et tourne à plein régime pour frapper la monnaie."},
    {TR_BUILDING_CITY_MINT_MANY_EMPLOYEES, "L'atelier n'opère pas à sa capacité maximale. La production de monnaie sera par conséquent légèrement plus lente."},
    {TR_BUILDING_CITY_MINT_HALF_EMPLOYEES, "L'atelier est en sous-effectif, et met plus de temps pour frapper la monnaie qu'elle ne le devrait."},
    {TR_BUILDING_CITY_MINT_SOME_EMPLOYEES, "Très peu d'employés travaillent dans cet atelier. La production de monnaie est par conséquent très lente."},
    {TR_BUILDING_CITY_MINT_FEW_EMPLOYEES, "Avec quasiment aucun employé dans cet atelier, la production est presque à l'arrêt. Très peu de pièces seront frappées pour l'année à venir."},
    ...
    {TR_BUILDING_CITY_MINT_NO_SENATE, "Ce bâtiment nécessite un sénat opérationnel pour fonctionner. Sans cela, aucune monnaie ne peut être frappée."},
