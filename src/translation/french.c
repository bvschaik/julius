...
static translation_string all_strings[] = {
    ...
    {TR_WINDOW_GAMES_OPTION_1, "Batailles navales" },
    {TR_WINDOW_GAMES_OPTION_2, "Jeux des fauves" },
    {TR_WINDOW_GAMES_OPTION_3, "Calendes de Janvier" },
    ...
    {TR_BUILDING_SMALL_TEMPLE_CONSTRUCTION_DESC, "La construction de ce temple nécessitera du matériel stocké dans un entrepôt, des ouvriers d'un camp de travail et des ingénieurs d'une guilde d'ingénieurs." },
    {TR_CITY_MESSAGE_TEXT_NAVAL_GAMES_PLANNING, "L'eau des réservoirs de la cité remplit lentement le Colisée. Les charpentiers commencent à assembler des navires de guerre alors que les gladiateurs s'entraînent au combat naval. Bientôt les jeux navals commenceront!" },
    {TR_CITY_MESSAGE_TEXT_NAVAL_GAMES_STARTING, "Le Colisée est devenu un lac artificiel alors que les gladiateurs reconstituent de grandes victoires romaines en mer. Le sang et l'eau se mélangent alors que la foule exulte. La naumachie - les jeux navals - ont commencé!" },
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_COOLDOWN, "Mois restant avant la tenue des prochains jeux: " },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_PREPARING_NG, "Mois restant avant les jeux navals:" },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_UNDERWAY_NG, "Les jeux navals sont en cours. Les éclaboussures d'eau, le grincement coques et les cris de guerre des gladiateurs s'ajoutent au rugissement de la foule." },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_PREPARING_AG, "Mois restant avant les jeux des fauves:" },
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_PREPARING_KG, "Mois restant avant les Calendes:" },
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_PREPARING_OG, "Mois restant avant les Jeux Olympiques:" },
