...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_DEPOT_DESC, "Le dépôt de charrettes envoie des charretiers transférer des biens entre les entrepôts et greniers en fonction de leur numéro. Les charretiers doivent retourner au dépôt après chaque livraison."},
