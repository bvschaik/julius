...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_PHASE_1_TEXT, "Les ingénieurs établissent les fondations de ce futur lieu de repos."},
    ...
    {TR_BUILDING_GOLD_MINE_MANY_EMPLOYEES, "Cette mine n'opère pas à sa capacité maximale. L'extraction d'or pourrait être légèrement plus efficace avec davantage de mineurs."},
    ...
    {TR_BUILDING_CITY_MINT_NO_GOLD, "Cet atelier a besoin qu'on lui livre de l'or, en provenance d'un entrepôt ou d'une mine d'or, afin de produire de la monnaie."},
    ...
    {TR_BUILDING_CITY_MINT_CHANGE_PRODUCTION, "Modifier la production de l'atelier monétaire ?"},
    ...
    {TR_EDITOR_SCENARIO_EVENTS_COUNT, "événements de scénario" },
    ...
    {TR_EDITOR_SCENARIO_EVENT_DELETED, "Evénement supprimé"},
    ...
    {TR_PARAMETER_TYPE_FUTURE_CITY, "Concerne cité commerciale potentielle"},
    {TR_PARAMETER_USE_PERCENTAGE, "En pourcentage?"},
    {TR_PARAMETER_IN_CITY_ONLY, "Seulement les soldats dans la cité?"},
    {TR_PARAMETER_CHECK_FOR_ONGOING, "Vérifier que la requête est en cours?"},
    {TR_PARAMETER_SHOW_MESSAGE, "Afficher le message?"},
    {TR_PARAMETER_SET_TO_VALUE, "Définir la valeur?"},
    {TR_PARAMETER_PRODUCED, "Produite?"},
    {TR_PARAMETER_ALLOWED, "Autorisé?"},
    {TR_PARAMETER_SET_BUY_PRICE, "Définir prix d'achat?"},
    ...
    {TR_CONDITION_TYPE_BUILDING_COUNT_ACTIVE, "Décompte actuel type de bâtiments"},
    ...
    {TR_ACTION_TYPE_TRADE_ADJUST_PRICE, "Modifier les prix commerciaux"},
    ...
    {TR_ACTION_TYPE_TRADE_ADJUST_ROUTE_AMOUNT, "Modifier quant. échange rte commerciale"},
    ...
    {TR_ACTION_TYPE_CHANGE_RESOURCE_PRODUCED, "Changer ressources locales disponibles"},
    ...
    {TR_ACTION_TYPE_TRADE_SET_PRICE, "Définir prix commercial"},
    {TR_ACTION_TYPE_EMPIRE_MAP_CONVERT_FUTURE_TRADE_CITY, "Convertir cité commerciale potentielle"},
    {TR_ACTION_TYPE_REQUEST_IMMEDIATELY_START, "Lancer immédiatement une requête"},
    {TR_PARAMETER_VALUE_COMPARISON_TYPE_EQUAL, "Egal"},
    ...
    {TR_PARAMETER_VALUE_MESSAGE_CITY_IN_DEBT, "Endettement de la cité"},
    {TR_PARAMETER_VALUE_MESSAGE_CITY_IN_DEBT_AGAIN, "Nouvel endettement"},
    {TR_PARAMETER_VALUE_MESSAGE_CITY_STILL_IN_DEBT, "Cité toujours débitrice"},
