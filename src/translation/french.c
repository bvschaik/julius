...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_OPEN_TO_IMPORT, "Ouvrir une route commerciale pour importer"},
    {TR_ADVISOR_OPEN_TO_EXPORT, "Ouvrir une route commerciale pour exporter"},
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_1, "Les navires achètent leurs biens 20% plus cher mais vendent pour 10% plus cher." },
    {TR_BUILDING_LIGHTHOUSE_POLICY_2_TITLE, "Libratum Artis" },
    {TR_BUILDING_LIGHTHOUSE_POLICY_2, "Les navires vendent leurs biens 20% moins cher mais achètent pour 10% moins cher." },
