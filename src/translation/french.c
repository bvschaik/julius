...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_MAX_GRAND_TEMPLES, "Nombre maximum de grands temples par ville :"},
    ...
    {TR_BUILDING_ROADBLOCK_DESC, "Les barrages routiers bloquent les citoyens errants."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_MARS_BONUS_DESC, "Forme les soldats à la manière d'une caserne. Quatre forts supplémentaires peuvent être construits."},
    ...
    {TR_BUILDING_PANTHEON_BONUS_DESC, "Donne accès à tous les dieux. Organise des festivals annuels et réduit la redevance des bâtiments religieux et culturels de 25 %."},
    {TR_BUILDING_GRAND_TEMPLE_CERES_MODULE_1_DESC, "Les prêtres réduisent la consommation alimentaire de 20 %."},
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_1_DESC, "Les temples fournissent des conducteurs de char pour l'Hippodrome."},
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_1_DESC, "Les prêtres réduisent de 20 % la consommation de poterie et de meubles."},
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_1_DESC, "Les temples génèrent de la nourriture, en fonction du nombre de maisons qu'ils couvrent, et la livrent au poste de ravitaillement. La redevance des forts est réduite de 25%."},
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "Le Temple monumental produit du vin en quantité adaptée à la population de la cité ayant accès au temple de Vénus. Les temples le collectent et le distribuent dans les maisons et tavernes."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_2_DESC, "Les prêtres augmentent la capacité des logements de 5 %. Le Temple monumental fournit de l'eau comme un réservoir rempli."},
    ...
    {TR_ADVISOR_FINANCE_LEVIES, "Redevances bâtiment"},
    ...
    {TR_BUILDING_MESS_HALL_DESC, "Le poste de ravitaillement collecte la nourriture des greniers de la cité afin de nourrir les soldats stationnés dans les forts. Un mauvais approvisionnement ralentira le recrutement et nuira au moral."},
    ...
    {TR_BUILDING_LEGION_FOOD_WARNING_1, "La récente pénurie alimentaire a réduit le moral"},
    ...
    {TR_WARNING_NO_MESS_HALL, "En premier un poste de ravitaillement pour vos soldats !"},
    ...
    {TR_FIGURE_TYPE_MESS_HALL_COLLECTOR, "Aide de l'Intendant"},
    ...
    {TR_CITY_MESSAGE_TEXT_NEPTUNE_BLESSING, "Récompensant le dévouement de votre cité, Neptune accorde un passage en douceur aux commerçants pendant douze mois, durant lesquels vos exportations rapporteront 50% de plus."},
    ...
    {TR_OVERLAY_LEVY, "Redevances"},
    {TR_TOOLTIP_OVERLAY_LEVY, " denarii payés en redevance par mois."},
    {TR_MAP_EDITOR_OPTIONS, "Réglages du scénario" },
    {TR_BUILDING_TAVERN, "Taverne" },
    {TR_BUILDING_GRAND_GARDEN, "Grand jardin" },
    {TR_BUILDING_TAVERN_DESC_1, "Cette taverne n'a pas d'employés et ne peut pas fonctionner correctement." },
    {TR_BUILDING_TAVERN_DESC_2, "Cette taverne n'a pas de vin et ne peut pas fonctionner correctement." },
    {TR_BUILDING_TAVERN_DESC_3, "La taverne propose des divertissements tant que le vin coule à flots. Un approvisionnement en viande augmenterait son attrait." },
    {TR_BUILDING_TAVERN_DESC_4, "Le vin abondant et l'odeur de la viande rôtie attirent dans cette taverne une foule enthousiaste pour les jeux de hasard, la musique et la bonne ambiance." },
    ...
    {TR_TOOLTIP_OVERLAY_TAVERN_6, "Cette maison a récemment vu passer le tavernier avec du vin et de la viande. Que la fête commence !" },
    ...
    {TR_WINDOW_GAMES_OPTION_5_DESC, "Le Colisée accueillera les Jeux Romains. Votre ville accueillera de nombreux voyageurs, désireux de prouver leur valeur. Ces célébrations vous apporteront les faveurs de l'empereur et de votre peuple pendant 12 mois." },
    ...
    {TR_CITY_MESSAGE_TEXT_KALENDS_GAMES_STARTING, "Les jeux commencent au lever du soleil aux Calendes de Janvier. Les prêtres effectuent des sacrifices d'animaux alors que les gladiateurs se préparent à mourir pour la faveur des dieux."},
    ...
    {TR_BUILDING_MARS_TEMPLE_MODULE_DESC_NO_MESS, "Ce temple collectera de la nourriture pour le poste de ravitaillement, une fois ce dernier construit." },
    ...
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MEDICINE, "Régler l'accès du personnel de santé" },
    ...
    {TR_RETURN_ALL_TO_FORT, "Tous revenir" },
    ...
    {TR_HOTKEY_COPY_SETTINGS, "Copier les paramètres du bâtiment" },
    {TR_HOTKEY_PASTE_SETTINGS, "Coller les paramètres du bâtiment" },
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEEDS_WORKERS, "Sans une équipe complète de prêtres et de serviteurs, le temple ne peut pas exécuter les rites et célébrations. Jusqu'à nouvel ordre, inutile d'espérer la faveur divine. "},
    {TR_BUILDING_COLOSSEUM_NEEDS_WORKERS, "Le Colisée requiert davantage d'employés pour assurer à tous les citoyens un divertissement digne de ce monument."},
    {TR_BUILDING_HIPPODROME_NEEDS_WORKERS, "L'Hippodrome requiert davantage d'employés afin de proposer un spectacle grandiose à tous les citoyens."},
    {TR_BUILDING_LIGHTHOUSE_NEEDS_WORKERS, "Le Phare ne dispose pas d'assez d'employés pour entretenir son feu. Les navires ne peuvent se fier à sa lumière pour atteindre nos docks."},
    {TR_BUILDING_CARAVANSERAI_NEEDS_WORKERS, "Sans les employés nécessaires, le Caravansérail ne pourra pas satisfaire toutes les caravanes."},
    {TR_BUILDING_ROOFED_GARDEN_WALL, "Muret couvert"},
    {TR_BUILDING_GARDEN_WALL_GATE, "Entrée de jardin"},
    {TR_BUILDING_GARDEN_WALL_GATE_DESC, "Une entrée unique empêchant les hôtes indésirables de troubler la quiétude des jardins."},
    {TR_WINDOW_BUILDING_DISTRIBUTION_CART_PUSHER_GETTING, "Le charretier est en route pour aller chercher les biens dans un autre entrepôt."},
    {TR_BUILDING_PALISADE, "Palissade" },
    {TR_BUILDING_PALISADE_DESC, "Ce solide mur de bois nous protègera des envahisseurs et des animaux sauvages."},
