...
static translation_string all_strings[] = {
    ...
    {TR_WINDOW_RACE_BLUE_HORSE_DESCRIPTION, "L'équipe bleue, les protégés de Neptune. L'élite de la jeunesse Romaine voulant faire ses preuves." },
    {TR_WINDOW_RACE_RED_HORSE_DESCRIPTION, "L'équipe rouge, célèbre pour accueillir le plus talentueux aurige de l'histoire de Rome, un ancien rameur, qui sauva le consul Romain." },
    ...
    {TR_WINDOW_RACE_GREEN_HORSE_DESCRIPTION, "L'équipe verte, se revendiquant héritiers des Celeres, cavaliers au temps du Royaume de Rome. Se considère comme l'élite parmi l'élite." },
};
