...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CERES_TEMPLE_QUOTE, "La première Cérès a appris à la biche qui travaillait à labourer\nLa Terre enceinte et à faire semer la graine.\nLa première pour l'homme a fourni une nourriture saine\nEt avec des lois justes fournies par le monde méchant.\n-Ovide, les Métamorphoses, Livre V "},
    {TR_BUILDING_NEPTUNE_TEMPLE_QUOTE, "Les flots tombent, tandis que Neptune pose sa masse\nSur la mer agitée et lisse son visage sillonné.\nDéjà Triton, à son appel, apparaît au-dessus des vagues;\na robe tyrienne qu'il porte;\nEt dans sa main une trompette tordue porte.\n-Ovide, les Métamorphoses, Livre I "},
    {TR_BUILDING_MERCURY_TEMPLE_QUOTE, "Le bétail et les gros moutons peuvent tous être obtenus pour le raid,\ntripodes pour le commerce et étalons à tête fauve.\nMais le souffle de vie d'un homme ne peut pas revenir -\npas de pillards en force, aucun commerce ne le ramène, \nquand il glisse entre les dents serrées d'un homme.\n-Homer, L'Iliade, Livre IX "},
    {TR_BUILDING_MARS_TEMPLE_QUOTE, "Pour Mars, réparez ses arbres d'axes cassés et sa guerre émoussée,\nEt renvoyez-le avec les armes fourrées,\nPour réveiller la guerre paresseuse avec les alarmes bruyantes des trompettes.\n-Virgil, l'Énéide, Livre VIII"},
    ...
    {TR_BUILDING_MESS_HALL_DESC, "Le poste de ravitaillement recueille de la nourriture dans les greniers de la ville pour nourrir les soldats stationnés dans les forts de la ville. Un poste de ravitaillement mal approvisionné ralentira le recrutement et nuira au moral."},
    {TR_BUILDING_MESS_HALL_FULFILLMENT, "L'approvisionnement alimentaire du mois dernier:"},
    ...
    {TR_BUILDING_MENU_GOV_RES, "Demeures du gouverneur"},
    ...
    {TR_BUTTON_BACK_TO_MAIN_MENU, "Retour au menu principal"},
