...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_MESS_HALL_DESC, "Le poste de ravitaillement collecte la nourriture des greniers afin de nourrir les soldats stationnés dans les forts. Un mauvais ravitaillement ralentira le recrutement et nuira au moral."},
