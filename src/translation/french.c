...
static translation_string all_strings[] = {
    ...
    {TR_WINDOW_BUILDING_GOVERNMENT_LARGE_STATUE_WATER_WARNING, "Cette statue serait encore plus fabuleuse si sa fontaine ruisselait. Il lui suffirait juste d'un accès à l'eau." },
