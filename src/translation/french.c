...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD, "Autoriser les charretiers des greniers à évoluer hors route"},
    {TR_CONFIG_GRANARIES_GET_DOUBLE, "Doubler la capacité des charretiers employés par les greniers"},
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "Les jardins, les statues et les temples de la cité brillent d'une beauté accrue, ce qui augmente leur attrait. Les maisons stockent plus de marchandises et régressent plus lentement."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_2_DESC, "Les prêtres augmentent la capacité de logement de 5 %. Le Temple monumental fournit de l'eau comme un réservoir rempli."},
    ...
    {TR_ADVISOR_FINANCE_LEVIES, "Redevances édifices"},
    ...
    {TR_BUILDING_MESS_HALL_FULFILLMENT, "Approvisionnement du mois dernier :"},
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKERS, "Suspendre le transfert des biens vers les ateliers, fabriques, ou greniers"},
    ...
    {TR_BUILDING_TAVERN_DESC_3, "La taverne propose des divertissements tant que le vin coule à flots. Un approvisionnement en viande augmenterait sa réputation." },
    {TR_BUILDING_TAVERN_DESC_4, "Le vin abondant et le fumet de viande rôtie attirent dans cette taverne une foule enthousiaste pour les jeux de hasard, la musique et la bonne ambiance." },
    ...
    {TR_TOOLTIP_OVERLAY_TAVERN_2, "Aucun tavernier n'est passé dernièrement. Cette maison perdra bientôt accès à sa taverne." },
    {TR_TOOLTIP_OVERLAY_TAVERN_3, "Un tavernier servant du vin dans sa taverne, est passé près de cette maison." },
    {TR_TOOLTIP_OVERLAY_TAVERN_4, "Un tavernier servant du vin et de la viande dans sa taverne, est passé près de cette maison." },
    {TR_TOOLTIP_OVERLAY_TAVERN_5, "Un tavernier servant du vin dans sa taverne, est passé récemment près de cette maison." },
    {TR_TOOLTIP_OVERLAY_TAVERN_6, "Un tavernier servant du vin et de la viande dans sa taverne, est passé récemment près de cette maison. Que la fête commence !" },
    ...
    {TR_WINDOW_GAMES_OPTION_5_DESC, "Le Colisée accueillera les Jeux Romains. Votre ville accueillera de nombreux voyageurs, désireux de prouver leur valeur. Ces célébrations vous apporteront l'estime de l'Empereur et de votre peuple pendant 12 mois." },
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEEDS_WORKERS, "Sans une équipe complète de prêtres et de serviteurs, ce temple ne peut pas exécuter les rites sacrés et célébrations. Jusqu'à nouvel ordre, inutile d'espérer la faveur divine."},
