...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_BONUS_DESC, "Accorde +1 en portée pour les fontaines et puits et +2 pour les réservoirs. La main-d'œuvre du service des eaux est réduite de 50 %. Les navires marchands voyagent 25 % plus vite."},
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_BONUS_DESC, "Les marchands terrestres et maritimes ont une capacité supplémentaire de 50 %. Les marchands terrestres se déplacent 25 % plus vite."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "Les jardins, les statues et les temples de la cité brillent d'une beauté accrue, ce qui augmente leur attrait. Les logements stockent plus de marchandises et régressent plus lentement."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "Le temple monumental produit du vin en quantité adaptée à la population de la cité ayant accès aux temples de Vénus. Les temples le collectent et le distribuent dans les logements et tavernes."},
    ...
    {TR_CITY_MESSAGE_TEXT_SICKNESS, "La peste s'est déclarée dans la cité, un bâtiment a été placé en quarantaine et un médecin ou chirurgien est réquisitionné pour le décontaminer."},
