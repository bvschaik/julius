...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_RESIDENCES_USING_POTTERY, "Résidences demandant des poteries"},
    {TR_ADVISOR_RESIDENCES_USING_FURNITURE, "Résidences demandant des meubles"},
    {TR_ADVISOR_RESIDENCES_USING_OIL, "Résidences demandant de l'huile"},
    {TR_ADVISOR_RESIDENCES_USING_WINE, "Résidences demandant du vin"},
