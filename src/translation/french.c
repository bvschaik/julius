...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_TEXT, "Séléctionner une politique commerciale terrestre pour votre cité. Vous pourrez modifier à tout moment pour le même coût." },
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "Les caravanes peuvent porter 50% plus de biens, mais se déplacent 15% mois vite." },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_1, "Les navires marchants achètent leurs biens 20% plus cher, mais vos importations maritimes vous coûtent 10% de plus." },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_3, "Les navires marchants emporter 50% plus de biens, mais se déplacent 15% mois vite." },
