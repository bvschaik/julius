...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_TRADE_RESOURCE_NOT_STORABLE, "Entreposage impossible"},
    {TR_ADVISOR_TRADE_RESOURCE_NOT_STORABLE_OR_TRADABLE, "Entreposage et commerce impossibles"},
    ...
    {TR_BUILDING_BRICKWORKS_DESC, "À partir de sable et d'argile, des briquetiers confectionnent ici des briques destinées à la construction des monuments."},
    ...
    {TR_BUILDING_CONCRETE_MAKER_NO_RESOURCES, "Cette fabrique a besoin d'un réservoir, et d'être livrée en sable depuis un entrepôt ou une carrière, afin de préparer du béton."},
