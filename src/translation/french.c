...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_PANTHEON_BONUS_DESC, "Donne accès à tous les dieux. Organise des festivals annuels et réduit les frais des bâtiments religieux et culturels de 25 %."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_1_DESC, "Les temples génèrent de la nourriture, en fonction du nombre de maisons qu'ils couvrent, et la livrent au poste de ravitaillement. Les frais des forts sont réduits de 25 %."},
    ...
    {TR_BUILDING_MESS_HALL_DESC, "Le poste de ravitaillement collecte la nourriture des greniers de la cité afin de nourrir les soldats stationnés dans les forts. Un mauvais ravitaillement ralentira le recrutement et nuira au moral."},
    ...
    {TR_BUILDING_MESS_HALL_FOOD_TYPES_BONUS_1, "Le régime alimentaire varié de vos soldats augmente grandement le moral."},
    {TR_BUILDING_MESS_HALL_FOOD_TYPES_BONUS_2, "Le régime alimentaire riche et nutritif apprécié par vos soldats augmente grandement le moral."},
    ...
    {TR_TOOLTIP_OVERLAY_LEVY, " denarii payés en frais par mois."},
