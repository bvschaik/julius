...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_DEPOT_DESC, "Le dépôt de charrettes envoie des charrettes transférer des biens entre les entrepôts et greniers en fonction de leur numéro. Les charrettes doivent retourner au dépôt après chaque livraison."},
    ...
    {TR_WARNING_WATER_NEEDED_FOR_BUILDING, "Le phare doit être placé près de l'eau"},
    ...
    {TR_BUILDING_VERYLOW_STAFF_DESC, "Ce bâtiment n'a quasiment aucune main-d'œuvre. Il ne fonctionnera que très lentement." },
    {TR_BUILDING_LOW_STAFF_DESC, "Ce bâtiment est désespérément en sous-effectif. Il ne fonctionnera qu'à vitesse réduite." },
    {TR_BUILDING_HALF_STAFF_DESC, "Ce bâtiment est sérieusement en sous-effectif. Il ne fonctionnera qu'à vitesse réduite." },
    {TR_BUILDING_SOME_STAFF_DESC, "Ce bâtiment est en sous-effectif. Il ne fonctionnera pas de manière optimale." },
    {TR_BUILDING_MOST_STAFF_DESC, "Ce bâtiment a besoin de quelques employés supplémentaires pour ne pas perdre en efficacité." },
