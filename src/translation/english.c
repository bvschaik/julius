...
static translation_string all_strings[] = {
    ...
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_STARTING, "The solemn procession begins, and with it, the Roman Games. May the Jupiter himself judge the finest of today's competitors of races, bouts and other contests of stamina and agility. The Colosseum is filled to the brim with citizens awaiting the games and the customary gifts of wheat and olive oil. Let the games begin!" },
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_ENDING, "The final day of Roman Games comes to an end. Full of excitement, and with full stomachs, every citizen has tasted the greatness of Roman life. Glory to the Emperor, glory to the victors of the games, and glory to the governor!" },
