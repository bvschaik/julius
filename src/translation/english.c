...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "This arena hosts gladiators and animal hunts, to the delight of the locals. Local development allowed your citizens to expand the building, providing more seating to watch the shows." },
