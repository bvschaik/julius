...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CITY_MINT_FULL_EMPLOYEES, "The city mint has all the employees it needs. It is working flat out to mint coin."},
    {TR_BUILDING_CITY_MINT_MANY_EMPLOYEES, "The city mint is working below maximum capacity. Coin minting will be slightly slower as a result."},
    {TR_BUILDING_CITY_MINT_HALF_EMPLOYEES, "The city mint is understaffed, and it takes longer to mint coin than it should."},
    {TR_BUILDING_CITY_MINT_SOME_EMPLOYEES, "Very few people work here. Coin minting is slow as a result."},
    {TR_BUILDING_CITY_MINT_FEW_EMPLOYEES, "With hardly any employees at this workshop, minting is at a virtual standstill. It will almost mint no coin over the coming year."},
