...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_DESC, "The merchant caravans take advantage of this resting place and consume food."},
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_1, "Ships buy their goods up to 20% more but sell 10% more." },
    {TR_BUILDING_LIGHTHOUSE_POLICY_2_TITLE, "Libratum Artis" },
    {TR_BUILDING_LIGHTHOUSE_POLICY_2, "Ships sell their goods up to 20% cheaper but buy 10% less." },
