...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_TEXT, "Select a land trade policy for your city. Selecting a policy requires city funds." },
    {TR_BUILDING_CARAVANSERAI_POLICY_1_TITLE, "Consilium venditor terrae" },
    {TR_BUILDING_CARAVANSERAI_POLICY_1, "Landed seller's policy: Land exports earn 20% more, but land-based are 10% more expensive." },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_TEXT, "Select a sea trade policy for your city. Selecting a policy requires city funds." },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_3, "Maritime quantity policy: Ships carry 50% more goods, but move 15% slower." },
