...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_LOW, "Disease is a rare occurance in the city. The high standard of hygiene provided to residents effectively stems epidemics spreading here from other regions."},
    {TR_ADVISOR_SICKNESS_LEVEL_MEDIUM, "Some infectious diseases have appeared in the city, but the situation is under control. A sufficiently high level of healthcare will ensure a good hygiene in the city."},
    {TR_ADVISOR_SICKNESS_LEVEL_HIGH, "Infectious diseases spread in areas of the city. If the situation is not remedied soon, some buildings may be quarantined. More health facilities would effectively stem epidemics spreading here from other regions."},
    {TR_ADVISOR_SICKNESS_LEVEL_PLAGUE, "The plague has come to the city! Many residents fall ill and some buildings are severely impacted. What few doctors and surgeons are available have been requisitioned to decontaminate the most afflicted places. Action must be taken!"},
