...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEEDS_WORKERS, "Without a full staff of priests and attendants, this temple cannot perform all the sacred rites and celebrations. Until that changes, we should not expect divine favour. "},
    {TR_BUILDING_COLOSSEUM_NEEDS_WORKERS, "The Colosseum is understaffed. More workers are needed to ensure all of our citizens enjoy the games."},
    {TR_BUILDING_HIPPODROME_NEEDS_WORKERS, "The Hippodrome is understaffed. More workers are needed to provide spectacular entertainment for all of our citizens."},
    {TR_BUILDING_LIGHTHOUSE_NEEDS_WORKERS, "The Lighthouse is understaffed, and cannot keep the fire going. Ships struggle to find the way to our docks."},
