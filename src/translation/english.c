...
static translation_string all_strings[] = {
    ...
    {TR_TOOLTIP_BUTTON_REJECT_QUARTERMASTER, "Don't allow quartermaster to get food here"},
    ...
    {TR_TOOLTIP_BUTTON_REJECT_WORKCAMP, "Don't allow workcamps to get from here"},
