...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_PHASE_2, "(Placeholder text)"},
    {TR_BUILDING_CARAVANSERAI_PHASE_1_TEXT, "Engineers lay the foundation of a shelter for traders."},
    {TR_BUILDING_CARAVANSERAI_PHASE_2_TEXT, "This is a nice placeholder text. Please nag Areldir for him to add it. He volunteered so he must be nagged now."},
    ...
    {TR_CITY_WARNING_BUILD_STONE_MINE, "Build a stone mine"},
    ...
    {TR_BUILDING_VERYLOW_STAFF_DESC, "Building is severely understaffed. Will operate at a greatly reduced speed." },
