...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_SCHOOL_UPGRADE_DESC, "This school is operational. Local developments allowed your citizens to expand the building to greater size, providing space for more children to study at the same time."},
    {TR_BUILDING_THEATRE_UPGRADE_DESC, "This theater is operational. Local developments allowed your citizens to expand the building to greater size, satisfying the entertainment needs of more people." },
    {TR_BUILDING_LIBRARY_UPGRADE_DESC, "This library is operational. Local developments allowed your citizens to expand the building to a greater size, satisfying the education needs of more people." },
