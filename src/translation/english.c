...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_TEXT, "Select a land trade policy for your city. You can change it at any time, for a cost." },
    {TR_BUILDING_CARAVANSERAI_POLICY_1_TITLE, "Consilium venditor terrae" },
    {TR_BUILDING_CARAVANSERAI_POLICY_1, "Landed seller's policy: Trade caravan exports earn 20% more, but land-based imports are 10% more expensive." },
    {TR_BUILDING_CARAVANSERAI_POLICY_2_TITLE, "Consilium emptor terrae" },
    {TR_BUILDING_CARAVANSERAI_POLICY_2, "Landed buyer's policy: Trade caravan imports are 20% cheaper, but land-based exports earn 10% less." },
    {TR_BUILDING_CARAVANSERAI_POLICY_3_TITLE, "Consilium quantitas terrae" },
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "Landed quantity policy: Trade caravans carry 50% more goods, but move 15% slower." },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_TEXT, "Select a sea trade policy for your city. You can change it at any time, for a cost." },
    {TR_BUILDING_LIGHTHOUSE_POLICY_1_TITLE, "Consilium venditor maritimae" },
    {TR_BUILDING_LIGHTHOUSE_POLICY_1, "Maritime seller's policy: Trade ship exports earn 20% more, but sea-based imports are 10% more expensive." },
    ...
    {TR_WINDOW_GAMES_OPTION_2_DESC, "The Colosseum will host gruesome animal hunts and executions by wild beasts, delighting the plebeian classes. Crime, riots, and revolts will be suppressed for the next year. Gladiators will help defend the city from the next invasion." },
    ...
    {TR_CITY_MESSAGE_TEXT_ANIMAL_GAMES_PLANNING, "Strange cargo begins to appear in your city as traders from the far reaches of the earth deliver terrifying beasts to the cages beneath the Colossum. Soon a gruesome spectacle will delight your people." },
    ...
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_PLANNING, "With the announcement of Roman Games, people from the furthest reaches of the empire flock to your city, many hoping to win the upcoming competitions. It will take no less than a full year to see every possible preparation made." },
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_STARTING, "The solemn procession begins, and with it, the Roman Games. May Jupiter himself judge the finest of today's competitors of races, bouts and other contests of stamina and agility. The Colosseum is filled to the brim with citizens awaiting the games and the customary gifts of wheat and olive oil. Let the games begin!" },
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_ENDING, "The final day of Roman Games comes to an end. Brimmed of excitement, and with full stomachs, every citizen has tasted the greatness of Roman life. Glory to the Emperor, glory to the victors of the games, and glory to the governor!" },
    ...
    {TR_BUILDING_WATCHTOWER_DESC, "Archers on the battlements of this tower keep a vigilant watch for any sign of invaders, while watchmen patrol the streets below." },
    {TR_BUILDING_NYMPHAEUM, "Nymphaeum"},
    {TR_BUILDING_NYMPHAEUM_DESC, "This great temple is dedicated to the water nymphs - minor deities of spring, river and sea. It promises beauty and plenty to the surrounding land and the favor of the divine to the city." },
    {TR_BUILDING_SMALL_MAUSOLEUM, "Small Mausoleum"},
    {TR_BUILDING_SMALL_MAUSOLEUM_DESC, "This building is the final resting place of many past generations of your city's proud families, and the envy of many amongst the living." },
    {TR_BUILDING_LARGE_MAUSOLEUM, "Large Mausoleum"},
    {TR_BUILDING_LARGE_MAUSOLEUM_DESC, "The polished marble walls and gleaming statues of this magnificent structure reflect the great deeds of the most distinguished patricians who earned the privilege of resting here." },
    ...
    {TR_BUILDING_SCHOOL_UPGRADE_DESC, "This school is operational. Local developments allowed your citizens to expand the building to a greater size, providing space for more children to study at the same time."},
    {TR_BUILDING_THEATRE_UPGRADE_DESC, "This theater is operational. Local developments allowed your citizens to expand the building to a greater size, providing seating for more people to watch the shows." },
    {TR_BUILDING_LIBRARY_UPGRADE_DESC, "This library is operational. Local developments allowed your citizens to expand the building to a greater size, providing additional racks of scrolls for more people to read." },
    {TR_WINDOW_BUILDING_INFO_WARNING_NO_MONUMENT_ROAD_ACCESS, "This monument construction site has no road access. To ensure that construction is possible, make sure that a road is connected to one of the middle tiles."},
    ...
    {TR_BUILDING_MONUMENT_CONSTRUCTION_ARCHITECT_NEEDED, "This monument has all the materials needed for this phase. Workers await a skilled architect from an architects' guild to oversee any further construction." },
    {TR_RETURN_ALL_TO_FORT, "Return all" },
    {TR_TOOLTIP_ADVISOR_ENTERTAINMENT_GAMES_BUTTON, "Games information" },
    {TR_WINDOW_BUILDING_GOVERNMENT_LARGE_STATUE_WATER_WARNING, "This statue looks fabulous, but it would look even grander with its fountain active. Provide it with water access." },
    ...
    {TR_TOOLTIP_ADVISOR_TRADE_LAND_POLICY_REQUIRED, "A Caravanserai is required in your city to choose a land trade policy"},
    {TR_TOOLTIP_ADVISOR_TRADE_SEA_POLICY, "Select a sea trade policy"},
    {TR_TOOLTIP_ADVISOR_TRADE_SEA_POLICY_REQUIRED, "A Lighthouse is required in your city to choose a sea trade policy"},
