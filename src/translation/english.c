...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_BUILD_CLEAR_LAND, "Clear land tool"},
    {TR_HOTKEY_BUILD_VACANT_HOUSE, "Build house"},
    {TR_HOTKEY_BUILD_ROAD, "Build road"},
    {TR_HOTKEY_BUILD_PLAZA, "Build plaza"},
    {TR_HOTKEY_BUILD_GARDENS, "Build gardens"},
    {TR_HOTKEY_BUILD_PREFECTURE, "Build prefecture"},
    {TR_HOTKEY_BUILD_ENGINEERS_POST, "Build engineers' post"},
    {TR_HOTKEY_BUILD_DOCTOR, "Build doctor"},
    {TR_HOTKEY_BUILD_GRANARY, "Build granary"},
    {TR_HOTKEY_BUILD_WAREHOUSE, "Build warehouse"},
    {TR_HOTKEY_BUILD_MARKET, "Build market"},
