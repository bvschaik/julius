...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_ADD_MODULE, "Construct module" },
    ...
    {TR_BUILDING_GRAND_TEMPLE_CERES_DESC, "Grand temple to Ceres" },
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_DESC, "Grand temple to Neptune" },
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "Placeholder for Venus bonus description" },
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_DESC, "Placeholder for Venus module description" },
    ...
    {TR_ADD_MODULE, "Construct temple module?"},
    {TR_BUILDING_TEMPLE_MODULE_CONSTRUCTED, "Module constructed."}
};
