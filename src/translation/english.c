...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_MEDIUM, "Some infectious diseases have appeared in the city, but the situation is under control. Ensure a correct level of hygiene by buildings clinics, in order for trade to not be impacted."},
    {TR_ADVISOR_SICKNESS_LEVEL_HIGH, "Many infectious diseases spread in some areas of the city. If you do not remedy the situation quickly, trade buildings may be put in quarantine. Build clinics and be sure to have a decent hospital coverage to stem epidemics from outside cities."},
