...
static translation_string all_strings[] = {
    ...
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_DESC, "Sponsor grand games at your Colosseum or Hippodrome using personal funds." },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_BUTTON, "Hold games" },
    {TR_WINDOW_ADVISOR_ENTERTAINMENT_GAMES_PREPARING, "Preparing the games" },
    ...
    {TR_ADVISOR_TOURISM_DESCRIPTION_2, "Unestablished" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_3, "Obscure" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_4, "Developing" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_5, "Established" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_6, "Well-known" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_7, "Fashionable" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_8, "Glorious" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_9, "Legendary" },
    {TR_ADVISOR_TOURISM_DESCRIPTION_10, "Eternal" },
