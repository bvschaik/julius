...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "The Grand temple produces wine, amount based on population with Venus access. Temples collect and distribute it to houses." },
    ...
    {TR_BUILDING_MARS_TEMPLE_MODULE_DESC, "The grand temple allows organizes priests of Mars to supply food offerings to your mess hall."},
