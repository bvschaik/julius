...
static translation_string all_strings[] = {
    ...
    {TR_CITY_MESSAGE_TEXT_EMPERORS_WRATH, "You have fallen from Caesar's grace and so he has ordered your arrest. Unless you restore your favor with the emperor, his elite legionnaries will soon invade your city." }
};
