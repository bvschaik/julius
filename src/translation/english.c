...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_PANTHEON_MODULE_DESC, "Placeholder for Pantheon module description" },
    ...
    {TR_BUILDING_PANTHEON_DESC_MODULE_1, "Pantheon with module placeholder name" },
    ...
    {TR_BUILDING_GRAND_TEMPLE_PHASE_4, "(Precinct)"},
    {TR_BUILDING_GRAND_TEMPLE_PHASE_5, "(Dedication)"},
    ...
    {TR_BUILDING_GRAND_TEMPLE_PHASE_4_TEXT, "Work on the temple precinct has begun, where worshippers will gather for public ceremonies." },
    {TR_BUILDING_GRAND_TEMPLE_PHASE_5_TEXT, "With the temple nearly complete, priests gather to perform the rites of dedication." },
