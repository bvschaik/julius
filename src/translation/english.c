...
static translation_string all_strings[] = {
    ...
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_PLANNING, "With the announcement of Roman Games, people from the furthest outskirs of the Empire being to your city flock to your city, many hoping to win the upcoming competitions. It will take no less than a full year to see every possible preparation made." },
