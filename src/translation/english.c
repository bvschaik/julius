...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_NO_FOOD, "UPGRADED TAVERN DESC PLACEHOLDER NO FOOD." },
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_AND_FOOD, "UPGRADED TAVERN DESC PLACEHOLDER HAS FOOD." },
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_BOTH_SHOWS, "AMPHI UPGRADED DESC PLACEHOLDER HAS BOTH SHOWS "},
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_GLADIATORS, "AMPHI UPGRADED DESC PLACEHOLDER HAS ACTORS BUT NO GLADIATORS" },
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_ACTORS, "AMPHI UPGRADED DESC PLACEHOLDER HAS GLADIATOR BUT NO ACTORS" },
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_SHOWS, "AMPHI UPGRADED DESC PLACEHOLDER HAS NO SHOWS" },
    {TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "ARENA UPGRADED DESC PLACEHOLDER HAS BOTH SHOWS" },
