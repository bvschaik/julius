...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_HIGH, "Många smittsamma sjukdomar sprider sig i delar av staden. Om du inte gör något åt det snart, kommer några byggnader kanske behöva sättas i karantän. Bättre tillgång till sjukvård skulle häjda epedemier från att spridas hit."},
	...
	{TR_ZOOM, "Zoom:"},
    {TR_WINDOW_ASSET_PREVIEWER_TITLE, "Tillgångsförhandsvisare"},
    {TR_WINDOW_ASSET_PREVIEWER_GROUP, "Grupp:"},
	{TR_WINDOW_ASSET_PREVIEWER_NO_GROUPS, "( inga groups )"},
    {TR_WINDOW_ASSET_PREVIEWER_TERRAIN, "Terräng:"},
    {TR_WINDOW_ASSET_PREVIEWER_PLAY_ANIMATIONS, "Spela animationer"},
    {TR_WINDOW_ASSET_PREVIEWER_REFRESH, "Förnya"},
    {TR_WINDOW_ASSET_PREVIEWER_QUIT, "Avsluta"},
    {TR_WINDOW_ASSET_PREVIEWER_ASSET, "Tillgång:"},
    {TR_WINDOW_ASSET_PREVIEWER_TERRAIN_NONE, "Ingen" },
    {TR_WINDOW_ASSET_PREVIEWER_TERRAIN_CENTRAL, "Central"},
    {TR_WINDOW_ASSET_PREVIEWER_TERRAIN_NORTHERN, "Nordlig"},
    {TR_WINDOW_ASSET_PREVIEWER_TERRAIN_DESERT, "Öken"},
    {TR_WINDOW_ASSET_PREVIEWER_NO_ASSETS, "Inga tillgångar"},
    {TR_WINDOW_ASSET_PREVIEWER_UNNAMED_ASSET, "( namnlös tillgång )"},
    {TR_WINDOW_ASSET_PREVIEWER_ANIMATION_FRAME, "( animationsbild )"},
    {TR_WINDOW_ASSET_PREVIEWER_SHOW_ANIMATION_FRAMES, "Visa animationsbild"},
