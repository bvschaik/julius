...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_LARGE_TEMPLE_CONSTRUCTION_DESC, "Att konstruera detta tempel fordrar material förvarat i ett handelsmagasin, arbetare från ett arbetarläger och arkitekter från arkitetsskrået." },
