...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_1, "Handelsvägssäljarens policy: Exportintäkter från handelskaravaners är 20% högre, men landbaserade importer är 10% dyrare." },
    {TR_BUILDING_CARAVANSERAI_POLICY_2_TITLE, "Consilium emptor terrae" },
    {TR_BUILDING_CARAVANSERAI_POLICY_2, "Handelsvägsköparens policy: Handelskaravanersexporter är 20% billigare, men exportintäkter från landbaserade är 10% mindre." },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_2, "Sjöfartsköparens policy: sjörfartsbaserade importer är 20% billigare, men exportintäkter från sjöfartshandel är 10% mindre." },
    ...
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_6, "De boende är stör sig på dig." },
    ...
    {TR_BUILDING_WINDOW_HOUSE_SUGGEST_ENTERTAINMENT, "De boende skulle uppskatta med underhållning." },
    ...
    {TR_WINDOW_GAMES_OPTION_2_DESC, "Ruskiga djurjakter och avrättningar av vilda odjur kommer arrangeras i Colosseum, vilket behagar plebeierna. Kriminella, upplopp och revolter kommer stävjas i 12 månader. Gladiatorer kommer hjälpa till att försvara staden vid nästa invasion." },
    ...
    {TR_CITY_MESSAGE_TEXT_ANIMAL_GAMES_PLANNING, "Underligt gods börjar dyka upp i staden då handelsmän levererar rysliga odjur från världens till burarna under Colosseum. Ohyggliga spektakel kommer snart att behaga ditt folk." },
    ...
    {TR_BUILDING_LARGE_MAUSOLEUM_DESC, "Inom denna magnifika byggnadens polerade marmorväggar har endast de mest framstående patricierna priviligieriet att få vila." },
    ...
    {TR_WARNING_VARIANT_TOGGLE, "Tryck på rotationsknappen för att växla mellan varianter av denna byggnad"},
    {TR_BUILDING_SCHOOL_UPGRADE_DESC, "Skolan undervisar elever och tack vare den förträffliga omgivningen har skolan kunnat expandera. Nu kan fler barn studera samtidigt."},
    {TR_BUILDING_THEATRE_UPGRADE_DESC, "Den vackra omgivningen har lett till att teatern har expenderat. Den större teatern kan tillgodose fler medborgares underhållningsbehov." },
    {TR_BUILDING_LIBRARY_UPGRADE_DESC, "Biblioteket har byggts ut tack vare den förtjusande omgivningen. Nu när det finns plats för fler rullar kommer fler romare ha tillgång till undervisning." },
