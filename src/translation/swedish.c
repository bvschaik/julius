...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_HIGH, "Många smittsamma sjukdomar sprider sig i delar av staden som följd av dålig hygienstandard. Om du inte gör något åt det snart, kommer några byggnader kanske behöva sättas i karantän. Bättre tillgång till sjukvård skulle häjda epedemier från att bryta ut."},
