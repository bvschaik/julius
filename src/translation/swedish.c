...
static translation_string all_strings[] = {
    ...
    { TR_BUILDING_NEPTUNE_TEMPLE_QUOTE, "Havets ursinne släcks,dess härskare lägger åt sidan treuddigt ljuster,\nsmeker till ro dess vågor och kallar Triton som mörkblå höjer upp ur djupen,\nmed skuldror täckta av musslor som sugit sig fast.\nSin ljudande snäcka manas han blåsa i\noch så bjuda strömmar och floder att retirera snabbt.\n-Ovidius, Metamorfoser, Bok I"},
