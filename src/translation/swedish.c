...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES, "Visa fontäners och brunnars räckvidd när hus byggs"},
...
//    {TR_CONFIG_DRAW_WALKER_WAYPOINTS, "Visa vagndragarens måldestination när du klickat på en byggnad."},
    ...
    {TR_BUILDING_WINDOW_INDUSTRY_LOW_EFFICIENCY_WORKSHOPS, "Denna byggnad har låg effektivitet. Antingen får den inte tillräckliga leveranser av råmaterial eller så fraktas den slutgiltiga varan för långt."},
    ...
    {TR_WINDOW_RACE_RED_HORSE_DESCRIPTION, "Det röda laget - känt som laget som leds av den mest framgångsrika kusken i Roms historia - en föredetta roddare som räddade livet på en romersk konsul."},
    ...
    {TR_ADVISOR_TRADE_RESOURCE_NOT_STORABLE, "Kan inte lagras"},
    {TR_ADVISOR_TRADE_RESOURCE_NOT_STORABLE_OR_TRADABLE, "Varan kan varken handlas med eller lagras"},
    ...
    {TR_BUILDING_LARGE_MAUSOLEUM_CONSTRUCTION_DESC, "För att konstruera detta mausoleum krävs lagrade material i ett varuhus, arbetare från ett arbetarläger, och arkitekter från ett arkitetsskrå."},
    ...
    {TR_BUILDING_SHRINE_MERCURY, "Mercuryaltare"},
    {TR_BUILDING_SHRINE_NEPTUNE, "Neptunealtare"},
