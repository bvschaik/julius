...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_LOW, "Ytterst få sjukdomar sprids i staden, och handeln flyter på utmärkt. Stadens hygiennivå förhindrar att epedemier sprids hit från andra städer."},
    {TR_ADVISOR_SICKNESS_LEVEL_MEDIUM, "Några smittsamma sjukdomar har spridit sig i staden, men läget är under kontroll. Förbättra stadens hygiennivå att förhindra att handeln påverkas. Sjukhus är effektivast för att förhindra epedemier."},
    {TR_ADVISOR_SICKNESS_LEVEL_HIGH, "Många smittsamma sjukdomar sprider sig i delar av staden. Om du inte gör något åt det snart, kommer handelsbyggnader kanske sättas i karantän. Bygg kliniker eller sjukhus vid hamnar, sädesmagasin och varuhus för att förhindra att epedemier sprids från andra städer."},
    {TR_ADVISOR_SICKNESS_LEVEL_PLAGUE, "Pesten drabbar staden vilket har en kraftig påverkan på handeln. Läkare eller kirurger krävs för att decinficera områden drabbade av epedemin. Situation måste åtgärdas!"},
