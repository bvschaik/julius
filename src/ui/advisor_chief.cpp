...
void UI_Advisor_Chief_drawBackground(int *advisorHeight)
{
    ...
    *advisorHeight = 23;
    ...
    if (Data_CityInfo.unemploymentPercentage > 0)
    {
        ...
        Widget::Text::drawPercentage(Data_CityInfo.unemploymentPercentage,
    ...
    if (Data_CityInfo.treasury > Data_CityInfo.financeBalanceLastYear)
    {
        ...
        Widget::Text::drawMoney(Data_CityInfo.treasury - Data_CityInfo.financeBalanceLastYear,
    ...
    else if (Data_CityInfo.treasury < Data_CityInfo.financeBalanceLastYear)
    {
        ...
        Widget::Text::drawMoney(Data_CityInfo.financeBalanceLastYear - Data_CityInfo.treasury,
