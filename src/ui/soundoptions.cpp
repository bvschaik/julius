...
void UI_SoundOptions_drawForeground()
{
    ...
    Widget::Text::drawPercentage(music->volume,
    ...
    Widget::Text::drawPercentage(speech->volume,
    ...
    Widget::Text::drawPercentage(effects->volume,
    ...
    Widget::Text::drawPercentage(city->volume,
