...
{
    {192, 100, 34, 34, ImageButton_Normal, 96, 0, buttonOk, Widget::Button::doNothing, 1, 0, 1},
    {256, 100, 34, 34, ImageButton_Normal, 96, 4, buttonCancel, Widget::Button::doNothing, 0, 0, 1},
};
...
void UI_PopupDialog_drawForeground()
{
    ...
    if (data.hasButtons)
    {
        Widget::Button::drawImageButtons(xOffset, yOffset, buttons, 2);
    }
    else
    {
...
void UI_PopupDialog_handleMouse(const mouse *m)
{
    ...
    if (data.hasButtons)
    {
        Widget::Button::handleImageButtons(xOffset, yOffset, buttons, 2, 0);
    }
