...
void UI_DonateToCityDialog_drawBackground()
{
    ...
    Widget::Text::drawNumberCentered(2000, baseOffsetX + 284, baseOffsetY + 221, 64, FONT_NORMAL_WHITE);
    Widget::Text::drawNumberCentered(5000, baseOffsetX + 364, baseOffsetY + 221, 64, FONT_NORMAL_WHITE);
    ...
    Widget::Text::drawNumber(Data_CityInfo.donateAmount, '@', " ",
