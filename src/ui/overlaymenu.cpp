...
{
    {0, 0, 160, 24, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 0, 0},
    {0, 24, 160, 48, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 1, 0},
    {0, 48, 160, 72, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 2, 0},
    {0, 72, 160, 96, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 3, 0},
    {0, 96, 160, 120, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 4, 0},
    {0, 120, 160, 144, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 5, 0},
    {0, 144, 160, 168, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 6, 0},
    {0, 168, 160, 192, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 7, 0},
    {0, 192, 160, 216, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 8, 0},
    {0, 216, 160, 240, CustomButton_Immediate, buttonMenuItem, Widget::Button::doNothing, 9, 0},
};
static CustomButton submenuCustomButtons[] =
{
    {0, 0, 160, 24, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 0, 0},
    {0, 24, 160, 48, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 1, 0},
    {0, 48, 160, 72, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 2, 0},
    {0, 72, 160, 96, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 3, 0},
    {0, 96, 160, 120, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 4, 0},
    {0, 120, 160, 144, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 5, 0},
    {0, 144, 160, 168, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 6, 0},
    {0, 168, 160, 192, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 7, 0},
    {0, 192, 160, 216, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 8, 0},
    {0, 216, 160, 240, CustomButton_Immediate, buttonSubmenuItem, Widget::Button::doNothing, 9, 0},
};
...
void UI_OverlayMenu_drawForeground()
{
    ...
    for (int i = 0; i < 8; i++)
    {
        Widget::Panel::drawSmallLabelButton(xOffset - 170, 74 + 24 * i,
...
void UI_OverlayMenu_handleMouse(const mouse *m)
{
    ...
    Widget::Button::handleCustomButtons(Data_CityView.widthInPixels - 170, 72,
