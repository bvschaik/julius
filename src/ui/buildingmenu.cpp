...
{
    {0, 0, 256, 20, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 1, 0},
    {0, 24, 256, 44, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 2, 0},
    {0, 48, 256, 68, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 3, 0},
    {0, 72, 256, 92, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 4, 0},
    {0, 96, 256, 116, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 5, 0},
    {0, 120, 256, 140, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 6, 0},
    {0, 144, 256, 164, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 7, 0},
    {0, 168, 256, 188, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 8, 0},
    {0, 192, 256, 212, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 9, 0},
    {0, 216, 256, 236, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 10, 0},
    {0, 240, 256, 260, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 11, 0},
    {0, 264, 256, 284, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 12, 0},
    {0, 288, 256, 308, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 13, 0},
    {0, 312, 256, 332, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 14, 0},
    {0, 336, 256, 356, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 15, 0},
    {0, 360, 256, 380, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 16, 0},
    {0, 384, 256, 404, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 17, 0},
    {0, 408, 256, 428, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 18, 0},
    {0, 432, 256, 452, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 19, 0},
    {0, 456, 256, 476, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 20, 0},
    {0, 480, 256, 500, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 21, 0},
    {0, 504, 256, 524, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 22, 0},
    {0, 528, 256, 548, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 23, 0},
    {0, 552, 256, 572, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 24, 0},
    {0, 576, 256, 596, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 25, 0},
    {0, 600, 256, 620, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 26, 0},
    {0, 624, 256, 644, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 27, 0},
    {0, 648, 256, 668, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 28, 0},
    {0, 672, 256, 692, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 29, 0},
    {0, 696, 256, 716, CustomButton_Immediate, buttonMenuIndex, Widget::Button::doNothing, 30, 0},
};
...
static int handleBuildSubmenu()
{
    return Widget::Button::handleCustomButtons(
