    ...
    if (terrain & Terrain_Building)
    {
        if (Data_Grid_edge[gridOffset] & Edge_LeftmostTile)
        {
            ...
            case 0:
                ...
                break;
            case 1:
                Graphics_drawImage(graphicId + 1, xView, yView - 1);
                break;
            case 2:
                Graphics_drawImage(graphicId + 2, xView, yView - 2);
                break;
            case 4:
                Graphics_drawImage(graphicId + 3, xView, yView - 3);
                break;
            case 8:
                Graphics_drawImage(graphicId + 4, xView, yView - 4);
                break;
            }
        }
    }
