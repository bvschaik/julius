...
void UI_TopMenu_drawBackground()
{
    ...
    if (Data_Screen.width < 800)
    {
        ...
        Widget::Text::drawNumberColored(Data_CityInfo.treasury, '@', " ", 346 + width, 5, FONT_NORMAL_PLAIN, treasureColor);

        width = Widget_GameText_draw(6, 1, 458, 5, FONT_NORMAL_GREEN);
        Widget::Text::drawNumber(Data_CityInfo.population, '@', " ", 450 + width, 5, FONT_NORMAL_GREEN);
    ...
    else if (Data_Screen.width < 1024)
    {
        ...
        Widget::Text::drawNumberColored(Data_CityInfo.population, '@', " ", 466 + width, 5, FONT_NORMAL_PLAIN, COLOR_WHITE);
    ...
    else
    {
        ...
        Widget::Text::drawNumberColored(Data_CityInfo.treasury, '@', " ", 501 + width, 5, FONT_NORMAL_PLAIN, treasureColor);

        width = Widget_GameText_drawColored(6, 1, 645, 5, FONT_NORMAL_PLAIN, COLOR_WHITE);
        Widget::Text::drawNumberColored(Data_CityInfo.population, '@', " ", 651 + width, 5, FONT_NORMAL_PLAIN, COLOR_WHITE);
