...
# Create icon assets from existing icons
source_folder="res"
mipmap_folder="android/julius/src/main/res/mipmap"
...
# Copy SDL files to android folder
java_files_path="src/main/java/org/libsdl/app"
cp -a "ext/SDL2/SDL2/android-project/app/$java_files_path/." "android/julius/$java_files_path/"
