...
then
  sudo add-apt-repository universe && sudo apt-get update && sudo apt-get -y upgrade && sudo apt-get -y install libgl1-mesa-dev libsdl2-dev libsdl2-mixer-dev libfuse2
